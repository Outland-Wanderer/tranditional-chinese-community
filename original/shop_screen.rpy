translate traditional_chinese Sebas_Shopping_17f68e7d:

    # s "Take a look, here's our finest collections in the shop."
    s ""

translate traditional_chinese Sebas_Shopping_Loop_9d8ec6c6:
...
translate traditional_chinese Sebas_Shopping_Loop_9ffd8732:
...
translate traditional_chinese Sebas_Shopping_Loop_f7ffc5b5:
...
translate traditional_chinese Sebas_Shopping_Loop_eaa71874:
...
translate traditional_chinese Sebas_Shopping_Loop_2533c1b6:
...
translate traditional_chinese Sebas_Shopping_Loop_6a64b453:
...
translate traditional_chinese Sebas_Shopping_Loop_0d494bca:
...
translate traditional_chinese Sebas_Shopping_Loop_bd8065c8:
...
translate traditional_chinese Sebas_Shopping_Loop_d7b0b825:
...
translate traditional_chinese Sebas_Shopping_Loop_2d18a2b3:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_8bc0e9d3:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_9cebefc3:

    # g "Believe it or not, you can get this [ttt!t] for only [mmm] gold. One time offer."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_5f0c8525:

    # g "That's not my specialty, but I say this [ttt!t] is worth... [mmm] gold, probably."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_fb4526d8:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_2a750d15:

    # g "Well, how about [mmm] gold for this [ttt!t]? It's of the best quality, obviously."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_651f367a:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_8fc4508f:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_5e675378:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_0cb66860:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_d290fb34:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_875452c5:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_2c65202d:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_63432e0c:

    # g "You want this [ttt!t]? I can do [mmm] gold."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_f1780300:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_5a80a299:

    # g "After the two dimwits came back from the cave, one of them, the general came and dropped his little spell book here."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_6f08bf96:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_c2f3fedd:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_ecc4b476:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_c1582fa7:

    # g "Let's see. I say it's at most [mmm] gold, do you wanna sell this [ttt!t]?"
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_de9b97e5:

    # g "Uhm? Is this from the rune guardians? Condolences. I can buy this hand for [mmm] gold now."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_4f5a0197:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_a59ed0ff:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_9b079d01:

    # g "Not a specialist, but I can probably go for... [mmm] gold for this [ttt!t]."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_db0e8123:
...
translate traditional_chinese Gwyddyon_Shopping_Loop_1c8f6949:

    # g "This [ttt!t] seems promising. I can get you [mmm] gold for that."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_9cb1baca:

    # g "It was a great bargain, [e]. Thanks for the [mmm] gold and here's your [ttt!t]."
    g ""

translate traditional_chinese Gwyddyon_Shopping_Loop_28a63adc:

    # g "Mmmph. That can be useful. Here's the [mmm] gold for your [ttt!t]."
    g ""

translate traditional_chinese Methis_Shopping_ea62ce2b:

    # m "Take a look, here's our finest collections in the shop."
    m ""

translate traditional_chinese Methis_Shopping_Loop_f11cab7f:
...
translate traditional_chinese Methis_Shopping_Loop_c5ca73b2:
...
translate traditional_chinese Methis_Shopping_Loop_9fad9928:

    # m "Alright, this sounds like an opportunity to learn, for [mmm] gold."
    m ""

translate traditional_chinese Methis_Shopping_Loop_eaefdcc0:
...
translate traditional_chinese Methis_Shopping_Loop_8ac7ad31:

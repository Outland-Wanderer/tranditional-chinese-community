...
translate tranditional_chinese main_alchemists_cabin_72c73954:

    # h "The result is reduced, but just as spiritual as the real one."
    h ""

translate tranditional_chinese main_alchemists_cabin_b73b6cb7:

    # e "Thank you so much, Haskell."
    e ""

translate tranditional_chinese main_alchemists_cabin_bd41a4e6:

    # h "Well, next time Gwyddyon wants to sell you my own items, remember to stuff his mouth with his worthless crystals."
    h ""

translate tranditional_chinese main_alchemists_cabin_69491b20:
...
translate tranditional_chinese main_alchemists_cabin_cd2aa067:

    # "You nod, before Haskell chuckles slightly and returns to his hut."
    ""

translate tranditional_chinese main_woodland_outpost_134a4208:
...
translate tranditional_chinese main_woodland_outpost_c3d914a9:

    # e "Don't you fuckin run away again!"
    e ""

translate tranditional_chinese main_woodland_outpost_554537ac:

    # "You angrily catches it, this time the small sprout is trapped right in your palm."
    ""

translate tranditional_chinese main_woodland_outpost_65ab4a45:

    # e "Haha, YES!"
    e ""

translate tranditional_chinese main_woodland_outpost_e327378a:

    # "The small sprout convulses, jiggling as if it was hurt by your force. Your eyes widen, and immediately relaxes your hand."
    ""

translate tranditional_chinese main_woodland_outpost_72d88318:
...
translate tranditional_chinese main_woodland_outpost_b57712fd:

    # "You stomp the ground impatiently, it's unbelievable how it manipulated with your empathy just to escape."
    ""

translate tranditional_chinese main_woodland_outpost_2c3b668e:
...
translate tranditional_chinese main_woodland_outpost_21d7e940:

    # "You walk over to the entrance of the goat tribe, two guards are standing there."
    ""

translate tranditional_chinese main_woodland_outpost_4a5579c6:

    # "One of them immediately rushes inside, and a moment later, the general walks out towards you, still exhausted."
    ""

translate tranditional_chinese main_woodland_outpost_78c284fa:

    # k "Hey... Where's Furkan?"
    k ""

translate tranditional_chinese main_woodland_outpost_cca30a87:

    # e "He's fine, he told me to ask your guards to take him back."
    e ""

translate tranditional_chinese main_woodland_outpost_c2205134:

    # "Kari looks at you with surprise."
    ""

translate tranditional_chinese main_woodland_outpost_dcd86e92:

    # k "Oh?"
    k ""

translate tranditional_chinese main_woodland_outpost_c52956bf:

    # k "Alright... Thanks, Courier."
    k ""

translate tranditional_chinese main_woodland_outpost_57642efc:

    # "You can sense a sliver of gratitude in his voice, even when he doesn't spell it out loud."
    ""

translate tranditional_chinese main_woodland_outpost_82c5b073:

    # k "You should get some rest, I'll take over now."
    k ""

translate tranditional_chinese main_woodland_outpost_f9973791:

    # "He hands you some paper."
    ""

translate tranditional_chinese main_woodland_outpost_94e12146:

    # k "Here's some recipe I thought should prove useful to you."
    k ""

translate tranditional_chinese main_woodland_outpost_44668cc5:

    # k "It's iron sword and axe."
    k ""

translate tranditional_chinese main_woodland_outpost_4509fa69:

    # e "Ah, that sounds so great. Thanks a lot!"
    e ""

translate tranditional_chinese main_woodland_outpost_f622bd2d:

    # k "We'll talk later, both of us need to recover for a while."
    k ""

translate tranditional_chinese main_woodland_outpost_88472ec0:

    # e "See you!"
    e ""

translate tranditional_chinese main_woodland_outpost_56af5341:

    # "You reach the gate of the goat tribe, the guards looks at you in confusion."
    ""

translate tranditional_chinese main_woodland_outpost_135a5f89:

    # "It seems that there's no one in charge of the goat tribe now."
    ""

translate tranditional_chinese main_woodland_outpost_d7796cd2:

    # "The general is still in the cave, as you presume."
    ""

translate tranditional_chinese main_woodland_outpost_0681d622:

    # "The general is taking his rest after defeated by you."
    ""

translate tranditional_chinese main_woodland_outpost_da9cd745:

    # "And the chief is still inside the cave."
    ""

translate tranditional_chinese main_woodland_outpost_146c26b8:

    # "You decide that the guards won't let you in, and you move on back to the main road."
    ""

translate tranditional_chinese main_mossy_freshwater_f68a08be:
...
translate tranditional_chinese main_mossy_freshwater_cdc43bd0:

    # "You walk towards the river bank, before it slips away from the grasp of your hand, and wiggles away again."
    ""

translate tranditional_chinese main_mossy_freshwater_436b3870:

    # e "Argh! How did it escape again?"
    e ""

translate tranditional_chinese main_mossy_freshwater_4706c9aa:
...
translate tranditional_chinese ancient_tree_chop_bd47983b:
...
translate tranditional_chinese ancient_tree_chop_176da485:
...
translate tranditional_chinese ancient_tree_chop_a229b0ad:
...
translate tranditional_chinese sparkling_lagoon_drink_d45e1edf:
...
translate tranditional_chinese green_forest_loop_e59928dc:

    # "You look around the green forest for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese green_forest_loop_6795ba31:
...
translate tranditional_chinese green_forest_loop_ef997b7d:
...
translate tranditional_chinese green_forest_loop_ec9039c2:
...
translate tranditional_chinese green_forest_loop_3a490989:

    # "You put the red berry in your bag, you now have [item_number] red berry."
    ""

translate tranditional_chinese green_forest_loop_88e4ec00:

    # "You put the red berry in your bag, you now have [item_number] red berries."
    ""

translate tranditional_chinese green_forest_loop_7f533c9c:
...
translate tranditional_chinese green_forest_loop_b2dcd073:

    # "You put the blue berry in your bag, you now have [item_number] blue berry."
    ""

translate tranditional_chinese green_forest_loop_c44940ab:

    # "You put the blue berry in your bag, you now have [item_number] blue berries."
    ""

translate tranditional_chinese green_forest_loop_89ec9253:
...
translate tranditional_chinese green_forest_loop_a49cea3d:
...
translate tranditional_chinese green_forest_loop_e59928dc_1:

    # "You look around the green forest for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese green_forest_loop_511df20f:
...
translate tranditional_chinese ancient_tree_loop_15e9f5b1:
...
translate tranditional_chinese ancient_tree_loop_dc8dbdfd:

    # gt "Insolence, in the name of our lord! I will absolve you of your impure fate!"
    gt ""

translate tranditional_chinese ancient_tree_loop_e91ba75d:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese ancient_tree_loop_6f01ab1b:
...
translate tranditional_chinese ancient_tree_loop_eecd97a4:
...
translate tranditional_chinese ancient_tree_loop_fb7fa5e9:
...
translate tranditional_chinese ancient_tree_loop_90ff1c7f:
...
translate tranditional_chinese ancient_tree_loop_0c0256fc:

    # "You put the golden berry in your bag, you now have [item_number] golden berry."
    ""

translate tranditional_chinese ancient_tree_loop_0d9c03fa:

    # "You put the golden berry in your bag, you now have [item_number] golden berries."
    ""

translate tranditional_chinese ancient_tree_loop_4b974228:
...
translate tranditional_chinese ancient_tree_loop_5cc6c659:
...
translate tranditional_chinese ancient_tree_loop_af895a77:

    # "You take out your map and mark the spot. This is the Mossy Freshwater."
    ""

translate tranditional_chinese ancient_tree_loop_e91ba75d_1:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese ancient_tree_loop_3aef2234:
...
translate tranditional_chinese ancient_tree_loop_2feecdfe:
...
translate tranditional_chinese ancient_tree_loop_e91ba75d_2:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese sparkling_lagoon_loop_752145e3:

    # "Around the lagoon, you notice that there's a patch of small flowers nearby, you go and pick it up, it was a flax flower."
    ""

translate tranditional_chinese sparkling_lagoon_loop_bde92c53:

    # "You put the flax flower in your bag, you now have [item_number] flax flower."
    ""

translate tranditional_chinese sparkling_lagoon_loop_c2ae7326:

    # "You put the flax flower in your bag, you now have [item_number] flax flowers."
    ""

translate tranditional_chinese sparkling_lagoon_loop_0c517644:
...
translate tranditional_chinese sparkling_lagoon_loop_3a490989:

    # "You put the red berry in your bag, you now have [item_number] red berry."
    ""

translate tranditional_chinese sparkling_lagoon_loop_88e4ec00:

    # "You put the red berry in your bag, you now have [item_number] red berries."
    ""

translate tranditional_chinese sparkling_lagoon_loop_e3eefdaf:
...
translate tranditional_chinese sparkling_lagoon_loop_b2dcd073:

    # "You put the blue berry in your bag, you now have [item_number] blue berry."
    ""

translate tranditional_chinese sparkling_lagoon_loop_c44940ab:

    # "You put the blue berry in your bag, you now have [item_number] blue berries."
    ""

translate tranditional_chinese sparkling_lagoon_loop_c4468641:

    # "Along the lagoon, you found a leftover paper detailing the process to make a bucket."
    ""

translate tranditional_chinese sparkling_lagoon_loop_6248f077:

    # "It says making a wooden bucket requires 6 Wooden Logs and 4 Slime Balls. You mark down the recipe on your journal."
    ""

translate tranditional_chinese sparkling_lagoon_loop_28cfe685:

    # msg "New Recipe learned, check out Rahim's Workstation for more detail."
    msg ""

translate tranditional_chinese sparkling_lagoon_loop_e91ba75d:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese sparkling_lagoon_loop_e91ba75d_1:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese mossy_freshwater_loop_c78bb1b6:

    # "Around the river, you wander and pick up a certain plant, it was a Reed."
    ""

translate tranditional_chinese mossy_freshwater_loop_cf967e5f:

    # "You put the reed in your bag, you now have [item_number] Reed."
    ""

translate tranditional_chinese mossy_freshwater_loop_a5ea90ba:

    # "You put the reed in your bag, you now have [item_number] Reeds."
    ""

translate tranditional_chinese mossy_freshwater_loop_55cb61f1:

    # "Along the river bank, you notice that there's a patch of small flowers nearby, you go and pick it up, it was a sage."
    ""

translate tranditional_chinese mossy_freshwater_loop_04a4170f:

    # "You put the sage flower in your bag, you now have [item_number] sage flower."
    ""

translate tranditional_chinese mossy_freshwater_loop_f3e88ff2:

    # "You put the sage flower in your bag, you now have [item_number] sage flowers."
    ""

translate tranditional_chinese mossy_freshwater_loop_0471f10b:

    # "You walk on the side of the river, and notice something shiny... it was a recipe."
    ""

translate tranditional_chinese mossy_freshwater_loop_15e9e757:

    # "You quickly approach and pick it up. It says..."
    ""

translate tranditional_chinese mossy_freshwater_loop_ff5935ea:

    # "{i}...To make a trowel... craft with two slimeballs and two pieces of wood.{/i}"
    ""

translate tranditional_chinese mossy_freshwater_loop_f037af02:

    # "...You put the notes away, it seems you've learnt how to make a trowel."
    ""

translate tranditional_chinese mossy_freshwater_loop_7ab5ba61:

    # "After walking along the river for a while, you decide to walk downstream along the river."
    ""

translate tranditional_chinese mossy_freshwater_loop_4d13f8eb:

    # "It takes a long time for you to explore the forest as the river water splashes against your legs."
    ""

translate tranditional_chinese mossy_freshwater_loop_2d3f5440:
...
translate tranditional_chinese mossy_freshwater_loop_8d02a7d8:

    # "You take out your map and check your surrounding, this place must be the riverside crossing."
    ""

translate tranditional_chinese mossy_freshwater_loop_e91ba75d:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese mossy_freshwater_loop_e9de0dcf:

    # "You look into the river and found something grainy under the water."
    ""

translate tranditional_chinese mossy_freshwater_loop_ae8ac4b1:

    # "You use your trowel and soon dig up a piece of clay. You carefully store it in your bag."
    ""

translate tranditional_chinese mossy_freshwater_loop_06648869:

    # "You now have [item_num] pieces of clay."
    ""

translate tranditional_chinese mossy_freshwater_loop_7a4dea47:

    # "You try to dig through the mud with your bare hand... but to no avail, it seems to not work."
    ""

translate tranditional_chinese mossy_freshwater_loop_0ba9ac66:

    # "You decide to move on, maybe you need something small that can dig..."
    ""

translate tranditional_chinese mossy_freshwater_loop_fd01265d:

    # "Under the river bed, you found something glowing faintly, hidden deep between the rocks."
    ""

translate tranditional_chinese mossy_freshwater_loop_b4f1ef41:

    # "You use the trowel you brought with you, and dig through the smooth sand and mud underwater."
    ""

translate tranditional_chinese mossy_freshwater_loop_06a740d9:

    # "Soon, the hole becomes deep enough that you notice a branch glowing blue."
    ""

translate tranditional_chinese mossy_freshwater_loop_9e9f2c2c:

    # "With a little push, you pull out the branch, and feel a powerful aura coursing through your body..."
    ""

translate tranditional_chinese mossy_freshwater_loop_bc4d7076:

    # "It must be a trinket."
    ""

translate tranditional_chinese mossy_freshwater_loop_f0df0c49:

    # "You carefully put it in your bag. And step away from the water."
    ""

translate tranditional_chinese mossy_freshwater_loop_7a4dea47_1:

    # "You try to dig through the mud with your bare hand... but to no avail, it seems to not work."
    ""

translate tranditional_chinese mossy_freshwater_loop_0ba9ac66_1:

    # "You decide to move on, maybe you need something small that can dig..."
    ""

translate tranditional_chinese mossy_freshwater_loop_296a0bf4:

    # "After walking along the river for a while, you decide to climb upstream and explore the forest above."
    ""

translate tranditional_chinese mossy_freshwater_loop_f41a40bc:
...
translate tranditional_chinese mossy_freshwater_loop_97331535:

    # "You take out your map and mark the location, this place must be the woodland outpost."
    ""

translate tranditional_chinese mossy_freshwater_loop_dd81e7d4:

    # "After walking along the river for a while, you take a rest on the slippery rock..."
    ""

translate tranditional_chinese mossy_freshwater_loop_adcef476:

    # "Ouch!"
    ""

translate tranditional_chinese mossy_freshwater_loop_4c85091a:

    # "There's something under your butt, but luckily it's just a small note..."
    ""

translate tranditional_chinese mossy_freshwater_loop_c9ab56ee:

    # "{i}HOW TO MAKE SOFT FABRIC...{/i}"
    ""

translate tranditional_chinese mossy_freshwater_loop_0fd98fba:

    # "It's a recipe for soft fabric, you put it aside, maybe it'll be useful when you go back to Rahim's workshop."
    ""

translate tranditional_chinese mossy_freshwater_loop_f3fcd3e8:

    # "After walking along the river for a while, you decide to travel upstream."
    ""

translate tranditional_chinese mossy_freshwater_loop_14bb8b3d:

    # "You follow the river bank and walk opposite to where the water goes, you ascend and climb until you see a huge waterfall."
    ""

translate tranditional_chinese mossy_freshwater_loop_52d25bed:

    # "It seems you've arrived to the Sundersilk Cascades, you talk out your map and mark the location."
    ""

translate tranditional_chinese mossy_freshwater_loop_e91ba75d_1:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese woodland_outpost_loop_b9952a9e:
...
translate tranditional_chinese woodland_outpost_loop_e4ba1378:
...
translate tranditional_chinese woodland_outpost_loop_716e94fa:
...
translate tranditional_chinese woodland_outpost_loop_e91ba75d:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese woodland_outpost_loop_e91ba75d_1:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese woodland_outpost_loop_48fb9183:

    # "As you look around the woodland, you notice there's an unusual shadow at the peripheral of your sight."
    ""

translate tranditional_chinese woodland_outpost_loop_a6e00f15:

    # "You turn to the figure, its mass encapsulating your view. You notices its antler, and the eyes behind its mask."
    ""

translate tranditional_chinese woodland_outpost_loop_8e39c3eb:

    # "The sight is... familiar in some twisted way, you feel like you have been in this situation before."
    ""

translate tranditional_chinese woodland_outpost_loop_dd733f9a:

    # "Stranded at night in the forest, being chased by a mysterious figure."
    ""

translate tranditional_chinese woodland_outpost_loop_b21316a8:

    # "The figure approaches... you feel your muscles tense up. You are so ready to escape at any moment..."
    ""

translate tranditional_chinese woodland_outpost_loop_fc645303:

    # my "..."
    my ""

translate tranditional_chinese woodland_outpost_loop_2e6480a3:

    # my "Who, are you?"
    my ""

translate tranditional_chinese woodland_outpost_loop_2b40a022:

    # e "Huh?"
    e ""

translate tranditional_chinese woodland_outpost_loop_32516365:

    # "Instead of the unintelligible languages in your memory, you hear a young voice coming out of the figure."
    ""

translate tranditional_chinese woodland_outpost_loop_b95cc4d6:

    # "This deer, is bright in colour, and holding a scepter in his hand."
    ""

translate tranditional_chinese woodland_outpost_loop_54935489:

    # e "Uhmmm... I'm [e]."
    e ""

translate tranditional_chinese woodland_outpost_loop_317229cd:

    # my "Where are you from... and.. why are you here... at the middle of the night..."
    my ""

translate tranditional_chinese woodland_outpost_loop_9119c4e7:

    # e "I'm from Lusterfield. I was just exploring the area."
    e ""

translate tranditional_chinese woodland_outpost_loop_e628981d:

    # e "You... reminded me of someone."
    e ""

translate tranditional_chinese woodland_outpost_loop_6723c2e1:

    # my "W-what?"
    my ""

translate tranditional_chinese woodland_outpost_loop_9c5abfe1:

    # e "The demon that sent me here."
    e ""

translate tranditional_chinese woodland_outpost_loop_4b83c24d:

    # my "So, you are that courier."
    my ""

translate tranditional_chinese woodland_outpost_loop_d7bf05f9:

    # e "Hmm?"
    e ""

translate tranditional_chinese woodland_outpost_loop_a4000d3b:

    # my "The courier from Lusterfield, Chief told me about you."
    my ""

translate tranditional_chinese woodland_outpost_loop_2dd895ab:

    # my "I reckon you asked about some buddy of yours, Chime."
    my ""

translate tranditional_chinese woodland_outpost_loop_d38f2198:

    # e "Y-yes...?"
    e ""

translate tranditional_chinese woodland_outpost_loop_bfa6bbab:

    # my "Where's Chief now...?"
    my ""

translate tranditional_chinese woodland_outpost_loop_1e600dce:

    # e "W-what chief?"
    e ""

translate tranditional_chinese woodland_outpost_loop_2fe34dda:

    # my "Furkan... You saw him before, he saw you before."
    my ""

translate tranditional_chinese woodland_outpost_loop_03d7ead2:

    # my "Where is he..."
    my ""

translate tranditional_chinese woodland_outpost_loop_9c6176b1:

    # e "Uhm, I don't know."
    e ""

translate tranditional_chinese woodland_outpost_loop_13cf55be:

    # my "Look, any information you know, you shall spill your beans. Did the Lusterfolks take him?"
    my ""

translate tranditional_chinese woodland_outpost_loop_5819885f:

    # e "No, I'm sure no one would dare to kidnap your chief."
    e ""

translate tranditional_chinese woodland_outpost_loop_f7cd9910:

    # e "But... I do think of one thing."
    e ""

translate tranditional_chinese woodland_outpost_loop_4afcdf9c:

    # my "Huh?"
    my ""

translate tranditional_chinese woodland_outpost_loop_7864d137:

    # e "I did met a golem... that big."
    e ""

translate tranditional_chinese woodland_outpost_loop_2847a96a:

    # my "A golem?"
    my ""

translate tranditional_chinese woodland_outpost_loop_70890ddc:

    # e "It's full of moss, right over there."
    e ""

translate tranditional_chinese woodland_outpost_loop_db425602:

    # "You point at the river."
    ""

translate tranditional_chinese woodland_outpost_loop_fc645303_1:

    # my "..."
    my ""

translate tranditional_chinese woodland_outpost_loop_b328ad41:

    # my "I think I know where he is..."
    my ""

translate tranditional_chinese woodland_outpost_loop_b62414e7:

    # my "The damp cave."
    my ""

translate tranditional_chinese woodland_outpost_loop_2b40a022_1:

    # e "Huh?"
    e ""

translate tranditional_chinese woodland_outpost_loop_6a2ac76e:

    # my "Come on, we should go..."
    my ""

translate tranditional_chinese woodland_outpost_loop_ce0a52eb:

    # e "Me?"
    e ""

translate tranditional_chinese woodland_outpost_loop_83f30ffd:

    # my "I need a hand."
    my ""

translate tranditional_chinese woodland_outpost_loop_dc806ac7:

    # e "Really? I don't even know you."
    e ""

translate tranditional_chinese woodland_outpost_loop_02a3da0f:

    # my "I know you, You... you're coming with me either way, courier."
    my ""

translate tranditional_chinese woodland_outpost_loop_72a33094:

    # e "..."
    e ""

translate tranditional_chinese woodland_outpost_loop_937a8a1a:

    # "You and the mysterious figure wait for the sun to rise before proceeding."
    ""

translate tranditional_chinese woodland_outpost_loop_e91ba75d_2:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese woodland_outpost_loop_b629b50c:

    # "After walking along the forest for a while, you decide to go deeper into the forest."
    ""

translate tranditional_chinese woodland_outpost_loop_b40e55d3:

    # "You discovered that the tree seems to be denser than before, almost covering the sky above."
    ""

translate tranditional_chinese woodland_outpost_loop_e91ba75d_3:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese woodland_outpost_loop_0b22f34c:

    # "Around the outpost, you remember the specific bush from Furkan and pick up a certain plant, it was a Chrysanthemum."
    ""

translate tranditional_chinese woodland_outpost_loop_95390042:

    # "You put the flower in your bag, you now have [item_number] Chrysanthemum."
    ""

translate tranditional_chinese woodland_outpost_loop_813404ca:

    # "You put the flower in your bag, you now have [item_number] Chrysanthemums."
    ""

translate tranditional_chinese woodland_outpost_loop_e91ba75d_4:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese damp_cave_loop_e91ba75d:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese damp_cave_loop_e91ba75d_1:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese damp_cave_loop_e91ba75d_2:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese damp_cave_loop_e91ba75d_3:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese damp_cave_loop_e91ba75d_4:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese alchemists_cabin_loop_edc03792:

    # "Around the cabin, you wander and pick up a certain plant from the garden, it was a Hemp."
    ""

translate tranditional_chinese alchemists_cabin_loop_c27b0ffa:

    # "You put the hemp in your bag, you now have [item_number] hemp."
    ""

translate tranditional_chinese alchemists_cabin_loop_51ad78bd:

    # "You put the hemp in your bag, you now have [item_number] hemps."
    ""

translate tranditional_chinese alchemists_cabin_loop_13893b58:

    # "Around the cabin, you wander and pick up a certain plant from the garden, it was a Herb of Grace."
    ""

translate tranditional_chinese alchemists_cabin_loop_06c240e9:

    # "You put the herb of grace in your bag, you now have [item_number] herb of grace."
    ""

translate tranditional_chinese alchemists_cabin_loop_06c240e9_1:

    # "You put the herb of grace in your bag, you now have [item_number] herb of grace."
    ""

translate tranditional_chinese alchemists_cabin_loop_e91ba75d:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese alchemists_cabin_loop_07d928ef:

    # "Around the cabin, you wander and pick up a certain plant, it was a Rosemary."
    ""

translate tranditional_chinese alchemists_cabin_loop_aef11256:

    # "You put the Rosemary in your bag, you now have [item_number] Rosemary."
    ""

translate tranditional_chinese alchemists_cabin_loop_5622ab4d:

    # "You put the Rosemary in your bag, you now have [item_number] Rosemarys."
    ""

translate tranditional_chinese alchemists_cabin_loop_2fba35cf:

    # "Around the cabin, you wander and notice a small bump on the ground, you dig it up.. and it is a piece of ginger."
    ""

translate tranditional_chinese alchemists_cabin_loop_65e95ca8:

    # "You put the ginger in your bag, you now have [item_number] ginger."
    ""

translate tranditional_chinese alchemists_cabin_loop_c45c6227:

    # "You put the ginger in your bag, you now have [item_number] gingers."
    ""

translate tranditional_chinese scene_slime_sex_7652cf4c:
...
translate tranditional_chinese scene_slime_sex_a1d58699:

    # "But it didn't."
    ""

translate tranditional_chinese scene_slime_sex_1b9337db:
...
translate tranditional_chinese scene_slime_sex_a21041ec:
...
translate tranditional_chinese scene_slime_sex_96ff7f13:
...
translate tranditional_chinese scene_slime_sex_398cf691:
...
translate tranditional_chinese scene_slime_sex_f791e414:

    # e "W-what... are you doing..."
    e ""

translate tranditional_chinese scene_slime_sex_f6a57a38:
...
translate tranditional_chinese scene_slime_sex_1d6f585d:
...
translate tranditional_chinese scene_slime_sex_23c9fec3:

    # e "A-ahhhhh...."
    e ""

translate tranditional_chinese scene_slime_sex_3bdca4bc:
...
translate tranditional_chinese scene_slime_sex_2165b1c9:
...
translate tranditional_chinese scene_slime_sex_17e24080:
...
translate tranditional_chinese scene_slime_sex_df607395:

    # e "H-ahhhhh.... no... g-get off me!"
    e ""

translate tranditional_chinese scene_slime_sex_e2af583b:
...
translate tranditional_chinese scene_slime_sex_52201cb7:
...
translate tranditional_chinese scene_slime_sex_c87ffdc0:

    # "The sensation is haunting, sending your brain all the wrong signals that you might be enjoying this."
    ""

translate tranditional_chinese scene_slime_sex_50b4ace9:

    # e "Noo."
    e ""

translate tranditional_chinese scene_slime_sex_2454043a:
...
translate tranditional_chinese scene_slime_sex_b7a2ed5a:
...
translate tranditional_chinese scene_slime_sex_c6d1fb78:
...
translate tranditional_chinese scene_slime_sex_f4c22d45:
...
translate tranditional_chinese scene_slime_sex_38ea0c8e:

    # e "Ahhhh- A-hhhh."
    e ""

translate tranditional_chinese scene_slime_sex_85e20509:
...
translate tranditional_chinese scene_slime_sex_aa2c925a:
...
translate tranditional_chinese scene_slime_sex_1223f9cc:

    # e "I- I think... I'm... no I c-can't.... S-stop this."
    e ""

translate tranditional_chinese scene_slime_sex_0644dfe7:
...
translate tranditional_chinese scene_slime_sex_d911cff9:

    # e "Ha-aaaaaagh!!!"
    e ""

translate tranditional_chinese scene_slime_sex_15896e16:
...
translate tranditional_chinese scene_slime_sex_c6734a03:
...
translate tranditional_chinese scene_slime_sex_b768f5e4:
...
translate tranditional_chinese scene_slime_sex_96c19334:
...
translate tranditional_chinese scene_slime_sex_8016cc63:
...
translate tranditional_chinese scene_slime_sex_d4f4d1f3:

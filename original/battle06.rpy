...
translate traditional_chinese bandit_battle_loop_dc2c601b:

    # bd "Surrender and we'll just make you into our plaything. Isn't that what you're here for?"
    bd ""

translate traditional_chinese bandit_battle_loop_4b24e69b:
...
translate traditional_chinese bandit_battle_loop_45a9fad8:

    # "Your lust increased by [enemy_flirt]."
    ""

translate traditional_chinese bandit_battle_loop_a37a5cba:

    # "You are stunned by his gorgeous muscles, you mind wanders through scenarios of him being inside your body."
    ""

translate traditional_chinese bandit_battle_loop_45a9fad8_1:

    # "Your lust increased by [enemy_flirt]."
    ""

translate traditional_chinese bandit_battle_loop_7bfa850d:
...
translate traditional_chinese bandit_battle_loop_05b754b3:

    # "His attack at your lust seems to have failed as you stand there and wait for him to finish his taunt."
    ""

translate traditional_chinese bandit_battle_loop_3df25ad5:

    # "Both of you would never speak about it again."
    ""

translate traditional_chinese bandit_win_fc7c6359:

    # "The bandit is lying on the floor, still panting..."
    ""

translate traditional_chinese bandit_win_d8b2d3a2:

    # bd "My wounds will heal, and my brothers... we'll make you pay for this!"
    bd ""

translate traditional_chinese bandit_win_688f0e5d:

    # "He says furiously, but quickly composes when you stand in front of him."
    ""

translate traditional_chinese bandit_win_f8a21106:

    # bd "S-shit alright, alright. You win this time. I won't collect your toll... today."
    bd ""

translate traditional_chinese bandit_win_16b41cd5:

    # "You raise your fist towards the bandit again."
    ""

translate traditional_chinese bandit_win_0cdc15e9:

    # bd "O-ok, alright. 3 days without toll."
    bd ""

translate traditional_chinese bandit_win_a20cefa7:

    # "..."
    ""

translate traditional_chinese bandit_win_d0a8fdd8:

    # "You search around the bandit before letting him go."
    ""

translate traditional_chinese bandit_lose_8a7cdc8f:
...
translate traditional_chinese bandit_lose_4a386580:
...
translate traditional_chinese gnoll_battle_loop_1c513437:

    # gnl "Swift and sly, gnoll strikes hard."
    gnl ""

translate traditional_chinese gnoll_battle_loop_a077d02c:

    # gnl "You fast, but gnoll faster!"
    gnl ""

translate traditional_chinese gnoll_battle_loop_fb5206c6:

    # gnl "Jump, spin, gnoll catches indeed."
    gnl ""

translate traditional_chinese gnoll_battle_loop_ab81ba04:
...
translate traditional_chinese gnoll_battle_loop_b715bb14:

    # gnl "Gnoll takes hold, and you release!"
    gnl ""

translate traditional_chinese gnoll_battle_loop_01c20b58:
...
translate traditional_chinese gnoll_battle_loop_45a9fad8:

    # "Your lust increased by [enemy_flirt]."
    ""

translate traditional_chinese gnoll_battle_loop_a37a5cba:

    # "You are stunned by his gorgeous muscles, you mind wanders through scenarios of him being inside your body."
    ""

translate traditional_chinese gnoll_battle_loop_45a9fad8_1:

    # "Your lust increased by [enemy_flirt]."
    ""

translate traditional_chinese gnoll_battle_loop_03e56778:
...
translate traditional_chinese gnoll_battle_loop_05b754b3:

    # "His attack at your lust seems to have failed as you stand there and wait for him to finish his taunt."
    ""

translate traditional_chinese gnoll_battle_loop_3df25ad5:

    # "Both of you would never speak about it again."
    ""

translate traditional_chinese gnoll_win_49658594:

    # "The gnoll is lying on the floor, still panting..."
    ""

translate traditional_chinese gnoll_win_d854bdf5:

    # "As you search around the gnoll, you found three strips of leather, and a bundle of soft fur!"
    ""

translate traditional_chinese gnoll_win_57fa0099:

    # "As you search around the gnoll, you found a bundle of soft fur!"
    ""

translate traditional_chinese gnoll_win_aaa2a610:

    # "You also found a piece of colourful garment, a cloak that seems to be worn by... a famous bard?"
    ""

translate traditional_chinese gnoll_win_a20cefa7:

    # "..."
    ""

translate traditional_chinese gnoll_win_f3bc5f5e:

    # "Quickly, the gnoll crawls away, just before your eyes."
    ""

translate traditional_chinese gnoll_lose_60bcdbe4:
...
translate traditional_chinese gnoll_lose_8ae31ccb:
...
translate traditional_chinese bridgeroot_win_8860462c:

    # e "A-amb!"
    e ""

translate traditional_chinese bridgeroot_win_a3a4af4e:

    # "You stare at Amble, who just stands here, he is completely petrified, glancing between you and the bridgeroot."
    ""

translate traditional_chinese bridgeroot_win_276b2bc8:
...
translate traditional_chinese bridgeroot_win_d5f3c927:

    # a "Haargh!"
    a ""

translate traditional_chinese bridgeroot_win_9b56a923:

    # "Amble swings his hammer towards its head, and its shrieks just get louder all at once, which has shaken your very soul."
    ""

translate traditional_chinese bridgeroot_win_785c4d2e:

    # "The bridgeroot rises up, and then suddenly, it falls to the side with a resounding thump."
    ""

translate traditional_chinese bridgeroot_win_71b459d6:
...
translate traditional_chinese bridgeroot_win_a7b4cf16:
...
translate traditional_chinese bridgeroot_win_71bb5413:

    # e "I-I am so sorry, I know I promised we wouldn't kill him."
    e ""

translate traditional_chinese bridgeroot_win_c63515ac:

    # "He nods, almost hesitantly."
    ""

translate traditional_chinese bridgeroot_win_4693e987:

    # a "You were in danger right there, I had to."
    a ""

translate traditional_chinese bridgeroot_win_824577c7:

    # "Amble kneels down, swirling his finger against the dirts where the monster once resided."
    ""

translate traditional_chinese bridgeroot_win_dfe99824:

    # a "It was like what Lot described."
    a ""

translate traditional_chinese bridgeroot_win_ce753a35:

    # "You notice he slowly closes aimless eyes shut, his ears only droop lower."
    ""

translate traditional_chinese bridgeroot_win_a994b4a9:

    # e "The monster?"
    e ""

translate traditional_chinese bridgeroot_win_4faacc80:
...
translate traditional_chinese bridgeroot_win_cb7f1ca7:

    # a "Maybe, he made a good friend in the river here?"
    a ""

translate traditional_chinese bridgeroot_win_e416dd78:

    # e "Well, at least this one didn't want to outright murder us, immediately."
    e ""

translate traditional_chinese bridgeroot_win_060fd6d8:

    # "He gives you a few glances."
    ""

translate traditional_chinese bridgeroot_win_6d2f005d:

    # a "Let's continue our work, good friend."
    a ""

translate traditional_chinese bridgeroot_win_04ab9d9d:
...
translate traditional_chinese vurro_spar_battle_loop_a86f060c:

    # "Vurro punches you directly with his fist. Knocking you out momentarily. Your health decreases by [enemy_damage] HP."
    ""

translate traditional_chinese vurro_spar_battle_loop_cb8272e5:

    # "Vurro tries to punch you, but he misses just above your fur, he stands back in frustration."
    ""

translate traditional_chinese vurro_spar_battle_loop_bf81a2cb:

    # v "Look at that movement, you're doing pretty good."
    v ""

translate traditional_chinese vurro_spar_battle_loop_c1d9e09e:

    # v "Be careful, you might bleed for a while."
    v ""

translate traditional_chinese vurro_spar_battle_loop_52430236:

    # "Vurro slashes his hand across you, his claws easily scraping against your side. Your health decreases by [enemy_damage] HP."
    ""

translate traditional_chinese vurro_spar_battle_loop_c808726b:

    # "You begin to bleed from your wound."
    ""

translate traditional_chinese vurro_spar_battle_loop_10056391:

    # v "Huh, my claws are really getting sharper."
    v ""

translate traditional_chinese vurro_spar_battle_loop_d48a1192:

    # "Your bleeding has gotten worse from Vurro."
    ""

translate traditional_chinese vurro_spar_battle_loop_a518ffcc:

    # v "It's so weird... your blood scent is making me all dizzy."
    v ""

translate traditional_chinese vurro_spar_battle_loop_95989dfa:

    # "Vurro heaps a potion from his back pocket."
    ""

translate traditional_chinese vurro_spar_battle_loop_556d8e92:

    # v "Technically, Uffe doesn't like potions, but he might heal himself in some ways."
    v ""

translate traditional_chinese vurro_spar_battle_loop_b43cd03c:

    # "The brown werewolf raises his fist and swing swiftly towards your head."
    ""

translate traditional_chinese vurro_spar_battle_loop_2b15e1dd:

    # "It hits you pretty hard as you hold onto your nose, you are stunned for one round."
    ""

translate traditional_chinese vurro_spar_battle_loop_6bfe3d1b:

    # "You quickly tilt your head to the side, narrowly dodging his attack."
    ""

translate traditional_chinese vurro_spar_battle_loop_83bd4c2e:

    # v "Oh, you're quicker than I thought!"
    v ""

translate traditional_chinese vurro_spar_win_ca8eac9d:

    # v "U...ughhh..."
    v ""

translate traditional_chinese vurro_spar_win_4b71ba1d:

    # e "V-vurro?"
    e ""

translate traditional_chinese vurro_spar_win_1f454d5d:

    # "The brown werewolf in front of you looks extremely exhausted, struggling to open his eyes in front of you."
    ""

translate traditional_chinese vurro_spar_win_3201a0e5:

    # "Suddenly, he falls forwards to the ground with a big thump, raising a gust of dirts and grasses."
    ""

translate traditional_chinese vurro_spar_win_c72b9246:

    # e "H-hey! Vurro!"
    e ""

translate traditional_chinese vurro_spar_win_871ec0a7:

    # e "F-fuck, no. Wake up. Vurro!"
    e ""

translate traditional_chinese vurro_spar_win_b785c4fd:

    # "You rush towards the werewolf in full speed, leaning onto his chest to check for his pulse."
    ""

translate traditional_chinese vurro_spar_win_13840b92:

    # "For a few seconds, a loud doubt reverberates in your mind, telling you that you've just killed... your own friend."
    ""

translate traditional_chinese vurro_spar_win_c5871551:

    # v "[e]...?"
    v ""

translate traditional_chinese vurro_spar_win_145e9e83:

    # "He opens his eyes again, blinking. Staring at your worried face."
    ""

translate traditional_chinese vurro_spar_win_5cacdbed:

    # v "I-... I heard you screaming."
    v ""

translate traditional_chinese vurro_spar_win_552fcdac:
...
translate traditional_chinese werewolf_werewolf_win_4c49ded0:

    # "The werewolves are lying on the floor, still panting..."
    ""

translate traditional_chinese werewolf_werewolf_win_1854eb56:

    # "As you search around the werewolves, you found 2 Iron ores, 2 Pelts and [exp_drop] EXP!"
    ""

translate traditional_chinese werewolf_werewolf_win_3909bbba:

    # "As you search around the werewolves, you found 2 Pelt and [exp_drop] EXP!"
    ""

translate traditional_chinese werewolf_werewolf_win_d13a5aec:

    # "You also found a pair of trousers... from a Hunter."
    ""

translate traditional_chinese werewolf_werewolf_win_d31bae78:

    # "You also found an old copper pickaxe."
    ""

translate traditional_chinese werewolf_werewolf_win_497e235e:

    # "You leave the werewolf alone in the forest, he will probably wake up a few hours later."
    ""

translate traditional_chinese werewolf_werewolf_lose_fbbb586e:

...
translate tranditional_chinese caproot_battle_loop_93191504:
...
translate tranditional_chinese caproot_battle_loop_ba2a3c87:

    # "The caproot uses his roots to bring you closer, trying to see if you're breathing..."
    ""

translate tranditional_chinese caproot_battle_loop_56ab56ac:
...
translate tranditional_chinese caproot_battle_loop_954af16f:

    # "The caproot scrapes at your skin with his roots. Your health decreases by [enemy_damage] HP."
    ""

translate tranditional_chinese caproot_battle_loop_e3e1bdec:

    # "The caproot flings his arm towards you, but you manage to dodge the attack."
    ""

translate tranditional_chinese caproot_battle_loop_e360cf02:

    # "The caproot tries to catch you with his metal claws, but he misses it by inches."
    ""

translate tranditional_chinese caproot_battle_loop_e0d2a419:

    # "The caproot wraps your body with his roots..."
    ""

translate tranditional_chinese caproot_battle_loop_ff019558:

    # "He is holding you in place."
    ""

translate tranditional_chinese caproot_battle_loop_31ad1fd1:

    # "The caproot's root binds your horns, you are silenced for 2 rounds."
    ""

translate tranditional_chinese caproot_battle_loop_920ba405:

    # "The caproot heals himself with his own carrot."
    ""

translate tranditional_chinese caproot_win_b80cb596:

    # "As you defeat the caproot, it soon collapses..."
    ""

translate tranditional_chinese caproot_win_b92d8de2:

    # "It seems like it shrinks quickly into its normal state..."
    ""

translate tranditional_chinese caproot_win_64e65e0d:

    # "You pick up the carrot, and put it in your bag."
    ""

translate tranditional_chinese caproot_win_b34e8987:

    # "You found [gold_drop] gold and [exp_drop] EXP."
    ""

translate tranditional_chinese caproot_win_91f1d522:

    # msg "You are now Level [pc.level]! Check your inventory to allocate your level points."
    msg ""

translate tranditional_chinese caproot_lose_3a1157e3:

    # "You fell on the ground, the caproot is slowly approaching you."
    ""

translate tranditional_chinese caproot_lose_397870bb:

    # "It slaps you across with its root, knocking you out."
    ""

translate tranditional_chinese caproot_lose_a0930d76:

    # "You lost [lost_gold] Gold."
    ""

translate tranditional_chinese caproot_lose_455a7393:

    # "You wake up after a certain amount of time, a carrot on your hand... weird, as you thought to yourself."
    ""

translate tranditional_chinese caproot_lose_f6422074:

    # "The caproot is no where to be seen, must be a coincidence..."
    ""

translate tranditional_chinese caproot_lose_bde9e7c4:

    # "Shaking your head, you stand right back up and resume your adventure."
    ""

translate tranditional_chinese feral_battle_d7e42226:

    # "You are facing the feral werewolf, he extends his claws, staring at you with a mix of lust and innate hunger."
    ""

translate tranditional_chinese feral_battle_6fc4a6a5:

    # vw "Succumb..."
    vw ""

translate tranditional_chinese feral_battle_loop_a3273959:
...
translate tranditional_chinese feral_battle_loop_8986d773:
...
translate tranditional_chinese feral_battle_loop_06a20ea5:
...
translate tranditional_chinese feral_battle_loop_b1471927:

    # "You hold your fist and throw it at the feral werewolf, but it hits nothing and leaves you standing instead."
    ""

translate tranditional_chinese feral_battle_loop_c904a7f0:

    # vw "Mine..."
    vw ""

translate tranditional_chinese feral_battle_loop_51741249:

    # "The feral werewolf growls loudly."
    ""

translate tranditional_chinese feral_battle_loop_d5f94264:
...
translate tranditional_chinese feral_battle_loop_a8f95d37:
...
translate tranditional_chinese feral_battle_loop_2366a428:
...
translate tranditional_chinese feral_battle_loop_ce2792d0:
...
translate tranditional_chinese feral_battle_loop_e0d878bc:
...
translate tranditional_chinese feral_battle_loop_945cb1f9:
...
translate tranditional_chinese feral_battle_loop_edd0c29b:

    # "You throw your fist at the feral werewolf, hitting him right across his face, the sheer impact knocks him on the ground."
    ""

translate tranditional_chinese feral_battle_loop_f39c848d:

    # "You punch into the feral werewolf's stomach, grabbing him and slam him on the ground hard."
    ""

translate tranditional_chinese feral_battle_loop_24bcc736:

    # "His health decreases by [oa[4]] HP."
    ""

translate tranditional_chinese feral_battle_loop_a124f1fb:

    # "You've critically hit the feral werewolf, dealing [oa[4]] HP!"
    ""

translate tranditional_chinese feral_battle_loop_498fc07c:

    # vw "D-die..."
    vw ""

translate tranditional_chinese feral_battle_loop_971e581f:

    # vw "Fear..."
    vw ""

translate tranditional_chinese feral_battle_loop_e37c4e99:

    # "The feral werewolf howls, he extends his claws, slashing at anything on sight."
    ""

translate tranditional_chinese feral_battle_loop_4d5170a1:

    # vw "Broth-."
    vw ""

translate tranditional_chinese feral_battle_loop_ba6ebbc7:

    # vw "Cease..."
    vw ""

translate tranditional_chinese feral_battle_loop_f76ac578:
...
translate tranditional_chinese feral_battle_loop_fdf9de27:
...
translate tranditional_chinese feral_battle_loop_a6b1013a:
...
translate tranditional_chinese feral_battle_loop_225bd7f9:
...
translate tranditional_chinese feral_lose_321bc83a:
...
translate tranditional_chinese feral_lose_a20cefa7:

    # "..."
    ""

translate tranditional_chinese feral_lose_45482983:

    # "After you wake up, you realize the feral is fast asleep."
    ""

translate tranditional_chinese feral_lose_c20b51cc:

    # "The air still smells of sex."
    ""

translate tranditional_chinese feral_lose_7cb5d6e3:

    # "The intercourse was intense and it was an exhilarating feeling."
    ""

translate tranditional_chinese feral_lose_7dad0fdf:

    # "However, you know that your journey still awaits you, you cannot succumb to the lust in your mind... yet."
    ""

translate tranditional_chinese feral_lose_a367ab5f:

    # "You steal out of the cave."
    ""

translate tranditional_chinese feral_lose_a0930d76:

    # "You lost [lost_gold] Gold."
    ""

translate tranditional_chinese goatranger_battle_51753889:
...
translate tranditional_chinese goatranger_battle_d6144bf3:
...
translate tranditional_chinese goatranger_battle_loop_3f05fc52:
...
translate tranditional_chinese goatranger_battle_loop_214f9883:
...
translate tranditional_chinese goatranger_battle_loop_b0ba93ae:
...
translate tranditional_chinese goatranger_battle_loop_4518a86c:

    # "You aim and shoot your [pc.weapon.name!t] at the goat, the arrow hit right into his shoulder."
    ""

translate tranditional_chinese goatranger_battle_loop_94870dd3:
...
translate tranditional_chinese goatranger_battle_loop_edffacb3:

    # "You throw your fist at the goat, hitting him right across his face, the sheer impact knocks him on the ground."
    ""

translate tranditional_chinese goatranger_battle_loop_e02a18ea:

    # "You punch into the goat's stomach, grabbing him and slam him on the ground hard."
    ""

translate tranditional_chinese goatranger_battle_loop_24bcc736:

    # "His health decreases by [oa[4]] HP."
    ""

translate tranditional_chinese goatranger_battle_loop_3a298caa:

    # "You've critically hit the ranger, dealing [oa[4]] HP!"
    ""

translate tranditional_chinese goatranger_battle_loop_68b5c068:

    # gtr "Well, that hadn't happened before?"
    gtr ""

translate tranditional_chinese goatranger_battle_loop_8ffccf85:

    # gtr "Grrrrr! L-lucky hit... Let me teach you how to fight properly!"
    gtr ""

translate tranditional_chinese goatranger_battle_loop_cac625fb:

    # gtr "Damn... didn't know a courier can hit that hard...!"
    gtr ""

translate tranditional_chinese goatranger_battle_loop_ac5f8896:

    # gtr "H-hey, be gentle, I haven't gotten hit before."
    gtr ""

translate tranditional_chinese goatranger_battle_loop_fdf9de27:

    # "You turn around and rub your hand all over your own burly cheeks, feeling and brushing against your ass while you shake your hip."
    ""

translate tranditional_chinese goatranger_battle_loop_fb834191:
...
translate tranditional_chinese goatranger_battle_loop_c7da2682:
...
translate tranditional_chinese goatranger_battle_loop_9c39cd91:

    # "You continue your act for about a minute, but the ranger doesn't even flinch."
    ""

translate tranditional_chinese goatranger_battle_loop_c72d7161:

    # gtr "Well..."
    gtr ""

translate tranditional_chinese goatranger_battle_loop_6c790980:
...
translate tranditional_chinese goatranger_battle_loop_6a8cbe39:

    # gtr "...I-if you do this one more time I'm going to grab that huge ass and never let you go..."
    gtr ""

translate tranditional_chinese goatranger_battle_loop_02192b96:
...
translate tranditional_chinese goatranger_battle_loop_93076ad6:

    # gtr "You are w-wasting your time. I'm n-not... I'm not... I- uhh... nooo..."
    gtr ""

translate tranditional_chinese goatranger_battle_loop_a5ee8f98:
...
translate tranditional_chinese goatranger_battle_loop_942ffd1c:

    # gtr "N-noooo. I c-can't control... my mind. Please..."
    gtr ""

translate tranditional_chinese goatranger_battle_loop_2c300753:
...
translate tranditional_chinese goatranger_battle_loop_a3d8815c:

    # gtr "Hnnnngh... I n-need to... come."
    gtr ""

translate tranditional_chinese goatranger_battle_loop_d502f36e:

    # "You cannot run away from battle practice..."
    ""

translate tranditional_chinese goatranger_battle_loop_f45e5264:
...
translate tranditional_chinese goatranger_battle_loop_38120bdd:
...
translate tranditional_chinese goatranger_battle_loop_5244986f:

    # gtr "You thristy? Surrender to me and maybe you'll have the best time of your life."
    gtr ""

translate tranditional_chinese goatranger_battle_loop_71755195:
...
translate tranditional_chinese goatranger_battle_loop_7e097486:
...
translate tranditional_chinese goatranger_battle_loop_92acb165:

    # gtr "You see how strong of a specimen I am. Come closer to get a better look!"
    gtr ""

translate tranditional_chinese goatranger_battle_loop_21bad776:
...
translate tranditional_chinese goatranger_battle_loop_4a801cc0_1:

    # "The goat scratches at his loincloth, he put two of his fingers across his crotch, tracing the shape of his cock in front of you."
    ""

translate tranditional_chinese goatranger_battle_loop_5244986f_1:

    # gtr "You thristy? Surrender to me and maybe you'll have the best time of your life."
    gtr ""

translate tranditional_chinese goatranger_battle_loop_017c663f:
...
translate tranditional_chinese goatranger_battle_loop_7e097486_1:

    # "The ranger stretches his body, flaunting his muscular physiques, you can tell his soft chest is almost bulging in front of you."
    ""

translate tranditional_chinese goatranger_battle_loop_92acb165_1:

    # gtr "You see how strong of a specimen I am. Come closer to get a better look!"
    gtr ""

translate tranditional_chinese goatranger_battle_loop_969a6d77:
...
translate tranditional_chinese heftyslime_battle_04c594ed:
...
translate tranditional_chinese heftyslime_battle_31dfe629:
...
translate tranditional_chinese heftyslime_win_c81dbf8a:

    # "As you defeat the slime, the entity seems to disintegrate completely before your eyes."
    ""

translate tranditional_chinese heftyslime_win_974f007b:

    # "Only leaving behind drips and drops of green goo on the grass."
    ""

translate tranditional_chinese heftyslime_win_f7ad230e:

    # "You found a... Flagitious Ooze, what Haskell called."
    ""

translate tranditional_chinese heftyslime_win_a5a0418d:

    # "You found a... Teratoid Mucus, it was pretty slick."
    ""

translate tranditional_chinese heftyslime_win_b34e8987:

    # "You found [gold_drop] gold and [exp_drop] EXP."
    ""

translate tranditional_chinese heftyslime_win_91f1d522:

    # msg "You are now Level [pc.level]! Check your inventory to allocate your level points."
    msg ""

translate tranditional_chinese heftyslime_lose_880eb665:

    # "You fell on the ground, but the slime continues to slither towards you."
    ""

translate tranditional_chinese heftyslime_lose_8ff8cfd8:

    # "There's no strength left inside you to struggle against its grasp..."
    ""

translate tranditional_chinese heftyslime_lose_4ba96869:

    # "You lost [gold_lost] gold."
    ""

translate tranditional_chinese malignantslime_battle_0a7bd661:
...
translate tranditional_chinese malignantslime_battle_0d4fe669:
...
translate tranditional_chinese malignantslime_battle_loop_ef85913b:
...
translate tranditional_chinese malignantslime_battle_loop_a2251f49:

    # "The malignant slime slaps you in your sides, knocking you on the ground. It drains your health by [enemy_damage] HP."
    ""

translate tranditional_chinese malignantslime_battle_loop_33fe67ce:

    # "The malignant slime throws its gooey arms towards you, but you manage to dodge its attack."
    ""

translate tranditional_chinese malignantslime_battle_loop_e191c13f:

    # "The malignant slime tries to slap you in your sides, but it misses by inches."
    ""

translate tranditional_chinese malignantslime_battle_loop_fa3e35f2:

    # "The malignant slime glows faintly, connecting itself with the smaller slime."
    ""

translate tranditional_chinese malignantslime_battle_loop_add6ad39:

    # "It drains [healing] HP from the hefty slime."
    ""

translate tranditional_chinese malignantslime_battle_loop_dde7a710:

    # "A part of the malignant slime split apart! It is forming... another slime."
    ""

translate tranditional_chinese malignantslime_battle_loop_b56a75e4:

    # "You are now also facing Hefty Slime."
    ""

translate tranditional_chinese malignantslime_battle_loop_8e8b3794:

    # "The malignant slime wraps itself around you, refusing to let go of you."
    ""

translate tranditional_chinese malignantslime_battle_loop_81453e4d:

    # "You are now bound."
    ""

translate tranditional_chinese malignantslime_battle_loop_f93c263b:

    # "The malignant slime splashes itself onto your body, and infuses some form of... aphrodisiac through your fur."
    ""

translate tranditional_chinese malignantslime_battle_loop_f47325dc:

    # "Instantly your mind is filled with sexual scenes, you can't shake that thought... that image of you being naked with everyone else. Your lust increased by [enemy_flirt]."
    ""

translate tranditional_chinese malignantslime_win_c81dbf8a:

    # "As you defeat the slime, the entity seems to disintegrate completely before your eyes."
    ""

translate tranditional_chinese malignantslime_win_d5b3c93b:

    # "The smaller slime soon follow suit, slowly shrinking into a puddle of goo."
    ""

translate tranditional_chinese malignantslime_win_974f007b:

    # "Only leaving behind drips and drops of green goo on the grass."
    ""

translate tranditional_chinese malignantslime_win_b9d37beb:

    # "You found a Slime ball."
    ""

translate tranditional_chinese malignantslime_win_d00d3ee7:

    # "You found a Slime Grancrystal... embedded on the slime, it was quite a big one, might be bigger than what Haskell described."
    ""

translate tranditional_chinese malignantslime_win_20de44eb:

    # "You put the material into your bag."
    ""

translate tranditional_chinese malignantslime_win_b34e8987:

    # "You found [gold_drop] gold and [exp_drop] EXP."
    ""

translate tranditional_chinese malignantslime_win_91f1d522:

    # msg "You are now Level [pc.level]! Check your inventory to allocate your level points."
    msg ""

translate tranditional_chinese malignantslime_lose_880eb665:

    # "You fell on the ground, but the slime continues to slither towards you."
    ""

translate tranditional_chinese malignantslime_lose_8ff8cfd8:

    # "There's no strength left inside you to struggle against its grasp..."
    ""

translate tranditional_chinese malignantslime_lose_4ba96869:

    # "You lost [gold_lost] gold."
    ""

translate tranditional_chinese nosferat_battle_415c3c73:

    # "You are facing a nosferat, it is holding a form of dripstone while drooling at your body. You raise your fist in response."
    ""

translate tranditional_chinese nosferat_battle_8e2a78f9:
...
translate tranditional_chinese nosferat_battle_loop_176d157d:
...
translate tranditional_chinese nosferat_battle_loop_ce202c5a:

    # "You slam your [pc.weapon.name!t] into the nosferat's arm. It bounces right off. You can only look back in disbelief."
    ""

translate tranditional_chinese nosferat_battle_loop_e7d1878b:
...
translate tranditional_chinese nosferat_battle_loop_878e0a26:
...
translate tranditional_chinese nosferat_battle_loop_084cba4e:

    # "You throw your fist at the nosferat, hitting him across his face, the sheer impact of which knocks him to the ground."
    ""

translate tranditional_chinese nosferat_battle_loop_c5ea30ae:
...
translate tranditional_chinese nosferat_battle_loop_24bcc736:

    # "His health decreases by [oa[4]] HP."
    ""

translate tranditional_chinese nosferat_battle_loop_f7d01aa3:

    # "It seems you've hit the nosferat critically, dealing [oa[4]] HP!"
    ""

translate tranditional_chinese nosferat_battle_loop_c535ed1e:

    # "The nosferat grunts in anger, he definitely doesn't appreciate getting battered by a feeble watcher."
    ""

translate tranditional_chinese nosferat_battle_loop_a5012852:
...
translate tranditional_chinese nosferat_battle_loop_af0efd91:
...
translate tranditional_chinese nosferat_battle_loop_dcd7ef85:
...
translate tranditional_chinese nosferat_battle_loop_a1b73156:
...
translate tranditional_chinese nosferat_battle_loop_8fa7fb22:
...
translate tranditional_chinese nosferat_battle_loop_1ba028d0:

    # "You continue your act for about a minute, but the nosferat just stares at you in confusion."
    ""

translate tranditional_chinese nosferat_battle_loop_7854eb90:
...
translate tranditional_chinese nosferat_battle_loop_2ab85a68:
...
translate tranditional_chinese nosferat_battle_loop_e492040d:
...
translate tranditional_chinese nosferat_battle_loop_d0761fee:
...
translate tranditional_chinese nosferat_battle_loop_a9048373:
...
translate tranditional_chinese nosferat_battle_loop_4b584ee6:
...
translate tranditional_chinese nosferat_battle_loop_fa277270:
...
translate tranditional_chinese nosferat_battle_loop_65fac295:
...
translate tranditional_chinese werewolf_tetto_battle_loop_318e1d72:
...
translate tranditional_chinese werewolf_tetto_battle_loop_d09ca2fc:
...
translate tranditional_chinese werewolf_tetto_battle_loop_107bbb25:

    # "You hold your fist and throw it at the werewolf, but it hits nothing and leaves you standing instead."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_48ed0abb:

    # ww "Unlucky. But not surprised, hmmm..."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_77505ec7:

    # tt "You will make it next time."
    tt ""

translate tranditional_chinese werewolf_tetto_battle_loop_797886eb:

    # "The werewolf growls loudly while flexing his claws, it almost seems he's scoffing at your attempt of attack."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_070c20b1:
...
translate tranditional_chinese werewolf_tetto_battle_loop_123404a1:
...
translate tranditional_chinese werewolf_tetto_battle_loop_2ec11010:
...
translate tranditional_chinese werewolf_tetto_battle_loop_f0f3f2a9:
...
translate tranditional_chinese werewolf_tetto_battle_loop_2de98a20:

    # "You aim and shoot your [pc.weapon.name!t] at the werewolf, the arrow hit right into his shoulder and he screams in agony."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_667501f6:
...
translate tranditional_chinese werewolf_tetto_battle_loop_948f4e9b:

    # tt "Take my claw!"
    tt ""

translate tranditional_chinese werewolf_tetto_battle_loop_c9e8bcae:

    # tt "Hyaah! Leave it to me!"
    tt ""

translate tranditional_chinese werewolf_tetto_battle_loop_39dfd204:

    # "Tetto thrashes his claws at the werewolves, dealing [oa[4]] HP!"
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_8e14f488:

    # ww "F-fuck! We'll take you down in no time!"
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_9f1c07d6:

    # "The werewolf is now wounded."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_fdf9de27:

    # "You turn around and rub your hand all over your own burly cheeks, feeling and brushing against your ass while you shake your hip."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_679dfc1a:
...
translate tranditional_chinese werewolf_tetto_battle_loop_ca0f53ec:
...
translate tranditional_chinese werewolf_tetto_battle_loop_31e76fe0:

    # tt "What?"
    tt ""

translate tranditional_chinese werewolf_tetto_battle_loop_01a63a00:

    # e "You know, do something sexy..."
    e ""

translate tranditional_chinese werewolf_tetto_battle_loop_c9f47a91:

    # tt "W- Alright."
    tt ""

translate tranditional_chinese werewolf_tetto_battle_loop_28543999:

    # "Tetto puffs up his chest, flaunting his red brown fur in front of the werewolf."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_69c73a8c:

    # "You continue your act for about a minute, but the werewolf just stares at you in confusion."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_5ded777e:

    # "The werewolf just stares at Tetto... Eventually he stops out of embarrassment."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_482ade7e:

    # "Within a few seconds you can already see some movements under the werewolf's ripped pants."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_bb33b631:

    # "The sturdy beast man licks his lips, grumbling at your beautiful sight. His lust is increased by [player_flirt]."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_eaf69d5b:
...
translate tranditional_chinese werewolf_tetto_battle_loop_877a56ed:

    # "His lust is increased by [player_flirt]."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_8f8f53e6:

    # ww "Hmm... Come closer... little prey."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_b075c3a4:

    # ww "You have a nice body, little prey. Our pack would be delighted to see you."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_1876b221:

    # "The werewolf is squirming in reaction to your advance."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_f1da305a:

    # "You can already hear his rapid breathing and grunting, grasping at his own claws. His lust is increased by [player_flirt]."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_739aed5e:
...
translate tranditional_chinese werewolf_tetto_battle_loop_877a56ed_1:

    # "His lust is increased by [player_flirt]."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_aeda22d8:

    # ww "I-I can't hold... back- if you keep being like that."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_ec94cb21:

    # ww "L-little prey, y-our hole is mine. Now give up already and let me... f-fuck."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_1ff7aded:

    # "You can see that for some reason, the werewolf is weirdly attracted by Tetto's performance."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_135bc787:

    # ww "Hmmph...."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_877a56ed_2:

    # "His lust is increased by [player_flirt]."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_fa90019c:

    # "You look around, there's no way to escape without abandoning Tetto, and you're not ready for that."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_f88cd8cd:

    # "You raises your hand. Showing to the werewolves that you've accepted your fate."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_6311292d:

    # tt "We can still win this... right? [e]?"
    tt ""

translate tranditional_chinese werewolf_tetto_battle_loop_e98b05fd:

    # "You remain silent as Tetto lowers his arms, staring at the two werewolves in defeat."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_7f10568a:

    # tt "...I cannot fight them all by myself."
    tt ""

translate tranditional_chinese werewolf_tetto_battle_loop_604ef9eb:

    # "The werewolf flaunts his claw towards you. Your health decreases by [enemy_damage] HP."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_a42617c3:

    # "The werewolf charges at you, knocking you on the ground. Your health decreases by [enemy_damage] HP."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_641212a4:

    # "The werewolf flaunts his claw towards Tetto. His health decreases by [enemy_damage] HP."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_3cf7a290:

    # "The werewolf charges at Tetto, clashing his body onto the ground. His health decreases by [enemy_damage] HP."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_84eba930:

    # "The werewolf flaunts his claw towards you, you manage to dodge the attack."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_4947dbcf:

    # "The werewolf charges at you, trying to kick at your chest but you leap to your side in time."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_585efc05:

    # "The werewolf flaunts his claw towards Tetto, but he manage to dodge the attack."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_2d3d847d:

    # "The werewolf charges at Tetto, trying to push him on the ground, but he leaps away in time."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_9519dcb5:

    # ww "Heh... little prey. Give up now and maybe we'll give you and your friends a quick death."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_849beb2b:

    # ww "Tetto, we knew you're one of the weaklings, but we didn't expect such cowardice in you."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_7365540a:

    # ww "I'm almost done with you, little prey. Uffe will be elated to see your demise."
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_b7faf2ef:

    # ww "It's time, my friend, you know we can't let you escape, so why not make this quick?"
    ww ""

translate tranditional_chinese werewolf_tetto_battle_loop_078a90eb:

    # "The werewolf swings his claw at you, scraping against your side. Your health decreases by [enemy_damage] HP."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_e1d1f7bb:

    # "The werewolf swings his claw at Tetto, scraping against his side. His health decreases by [enemy_damage] HP."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_88f0fa84:

    # "Your bleeding has gotten worse from the werewolf."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_3034cbd4:

    # "Tetto is bleeding much worse now."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_23ba5b86:

    # "You begin to bleed from your wound as the werewolf watches in jeer."
    ""

translate tranditional_chinese werewolf_tetto_battle_loop_9ba2c9c7:

    # "Tetto begins to bleed from the newly-formed wound clawed by the werewolf."
    ""

translate tranditional_chinese werewolf_tetto_win_b7d13101:

    # "You pant heavily as both werewolves falls on the ground."
    ""

translate tranditional_chinese werewolf_tetto_win_2682f183:

    # "Without hesitation, you turn around to leave, only to see Tetto still staring at the werewolves."
    ""

translate tranditional_chinese werewolf_tetto_win_2fbd37a6:

    # ww "F-fuck. Uffe is going to kill us for letting you two go."
    ww ""

translate tranditional_chinese werewolf_tetto_win_bb29d3db:

    # ww2 "Ugh..."
    ww2 ""

translate tranditional_chinese werewolf_tetto_win_5aadbdd3:

    # tt "You can leave with us, escape the forest. Uffe can't reach you outside."
    tt ""

translate tranditional_chinese werewolf_tetto_win_a92be1d8:
...
translate tranditional_chinese werewolf_tetto_win_230f111c:

    # "The two defeated werewolves look at each other."
    ""

translate tranditional_chinese werewolf_tetto_win_5e44a316:

    # "Without another words, they staggers away from you two, towards the path you two took."
    ""

translate tranditional_chinese werewolf_tetto_win_cce190d1:

    # "It's clear the decision they've made was grim, but understandable."
    ""

translate tranditional_chinese werewolf_tetto_win_a9d36594:

    # ww2 "We didn't see anything."
    ww2 ""

translate tranditional_chinese werewolf_tetto_win_d81c263e:

    # "As they walk, the two turns to you and Tetto as they support each other's weights."
    ""

translate tranditional_chinese werewolf_tetto_win_6307dd3a:

    # "They slightly nods at you, eyes with a sorrowful look, before slowly disappearing into the mist."
    ""

translate tranditional_chinese werewolf_tetto_win_8104fd8b:

    # tt "Shall we continue? It's almost there."
    tt ""

translate tranditional_chinese werewolf_tetto_win_6186867a:

    # "You nod."
    ""

translate tranditional_chinese werewolf_tetto_win_3c582672:

    # "The maned werewolf picks up his brother, who's still in deep slumber."
    ""

translate tranditional_chinese werewolf_tetto_win_71ff470d:

    # "His step falters, but he manages to keep his balance despite the wounds and injuries."
    ""

translate tranditional_chinese werewolf_tetto_win_861b13e4:

    # tt "Say, [e]. You need to recommend me that lizard of yours, he's got a good recipe for an ointment, right?"
    tt ""

translate tranditional_chinese werewolf_tetto_win_3bc1b836:

    # e "Yeah, I think so."
    e ""

translate tranditional_chinese werewolf_tetto_win_b022e1a0:

    # tt "Good, I can use a whole jar right now."
    tt ""

translate tranditional_chinese werewolf_tetto_win_d43a60eb:

    # "Tetto smiles."
    ""

translate tranditional_chinese werewolf_tetto_win_00fa044f:

    # "It's clear Tetto has less of a mood to talk right now, considering what has panned out in the fight."
    ""

translate tranditional_chinese werewolf_tetto_win_49147c8e:

    # "And you decide to stay quiet as well, just to let your thought sinks in."
    ""

translate tranditional_chinese werewolf_tetto_win_b6c6f86e:

    # tt "What do you think the outside world has for us? Will it be good? Or the same."
    tt ""

translate tranditional_chinese werewolf_tetto_win_0d2189b4:

    # "After a while, the werewolf speaks once more."
    ""

translate tranditional_chinese werewolf_tetto_win_a39befb0:
...
translate tranditional_chinese werewolf_tetto_win_c710e707:

    # tt "Good is good enough."
    tt ""

translate tranditional_chinese werewolf_tetto_win_36ed6e52:

    # "Tetto takes another step, before he comes to a halt."
    ""

translate tranditional_chinese werewolf_tetto_win_340707dd:

    # e "We're out of the forest now."
    e ""

translate tranditional_chinese werewolf_tetto_win_2366ac62:

    # "You look around, hearing the splurging sound of water, you three seem to be near the cascades now."
    ""

translate tranditional_chinese werewolf_tetto_win_9acd25b7:

    # tt "Oh my- Everything is so bright here."
    tt ""

translate tranditional_chinese werewolf_tetto_win_8c4b00f0:

    # e "Yeah!"
    e ""

translate tranditional_chinese werewolf_tetto_win_ea7cc79e:

    # "Tetto walks around in awe as he lays down his sleeping brother."
    ""

translate tranditional_chinese werewolf_tetto_win_50044e74:

    # e "You sure you two are fine here? There are still monsters around, even though they're not as vicious as your people."
    e ""

translate tranditional_chinese werewolf_tetto_win_ada75c9e:

    # tt "Well, we're werewolves too!"
    tt ""

translate tranditional_chinese werewolf_tetto_win_57624fd4:

    # "He chides loudly, with a friendly smile."
    ""

translate tranditional_chinese werewolf_tetto_win_3aa2280f:

    # tt "Rumma is almost awake here, we'll be okay."
    tt ""

translate tranditional_chinese werewolf_tetto_win_a38549b4:

    # tt "However, we still want to get away as far as possible from Uffe, for now."
    tt ""

translate tranditional_chinese werewolf_tetto_win_bd7d5d0c:

    # "The werewolf grins."
    ""

translate tranditional_chinese werewolf_tetto_win_f9637a5b:

    # e "I'm so glad to be able to help you."
    e ""

translate tranditional_chinese werewolf_tetto_win_88a34193:

    # "He turns to you, this time with a warm glance."
    ""

translate tranditional_chinese werewolf_tetto_win_e6b7e0fb:

    # tt "And I'm glad you turned around, from Uffe."
    tt ""

translate tranditional_chinese werewolf_tetto_win_2b40a022:

    # e "Huh?"
    e ""

translate tranditional_chinese werewolf_tetto_win_b3c85c27:

    # tt "I just deduced that you had some tasks given by the alpha, from how those two in the forest spoke."
    tt ""

translate tranditional_chinese werewolf_tetto_win_9d4f9d3d:

    # tt "But regardless, you defied his order just to help strangers like us. That just makes me admire you more, little friend."
    tt ""

translate tranditional_chinese werewolf_tetto_win_134459a3:

    # "Tetto gives you a warm embrace, covering you easily in his red brown fur."
    ""

translate tranditional_chinese werewolf_tetto_win_3ba0ca2b:

    # "You don't know how to respond, you felt as if you've betrayed Tetto's trust, but somehow, he's grown to like you more."
    ""

translate tranditional_chinese werewolf_tetto_win_5132cd11:

    # tt "You helped treat Rumma's wound, and you escaped with us. That'll spell you a lot of troubles from Uffe."
    tt ""

translate tranditional_chinese werewolf_tetto_win_dd6039c0:

    # tt "Don't ever get near the den, and remember to conceal your smell around if you decide to go back."
    tt ""

translate tranditional_chinese werewolf_tetto_win_cf3278c6:

    # e "Actually, I've had help from Wuldon, he's just like you two, very good at hiding."
    e ""

translate tranditional_chinese werewolf_tetto_win_99c0e108:

    # tt "W-wuldon? The herbalist's son?"
    tt ""

translate tranditional_chinese werewolf_tetto_win_2b40a022_1:

    # e "Huh?"
    e ""

translate tranditional_chinese werewolf_tetto_win_6b21d205:

    # tt "I've seen that big blue werewolf before, but it's been so long."
    tt ""

translate tranditional_chinese werewolf_tetto_win_4b28a0e5:

    # tt "What is he up to?"
    tt ""

translate tranditional_chinese werewolf_tetto_win_1e99e1af:

    # e "Well, a few things. Maybe after everything, you'll be able to return to the forest whenever you'd like."
    e ""

translate tranditional_chinese werewolf_tetto_win_244a32e9:

    # tt "Hah, well, don't get my hopes up like that."
    tt ""

translate tranditional_chinese werewolf_tetto_win_16c96458:

    # e "I- I know."
    e ""

translate tranditional_chinese werewolf_tetto_win_142775fd:

    # tt "Well, I've seen a big blue werewolf carrying water around the split trails, perhaps you should go visit him sometimes."
    tt ""

translate tranditional_chinese werewolf_tetto_win_c72ef864:

    # e "I think I know him, we talked quite a lot about the pack's history."
    e ""

translate tranditional_chinese werewolf_tetto_win_cb23f038:

    # tt "That's great, he was the herbalist's son, actually. So I suppose he can get you around the forest easily."
    tt ""

translate tranditional_chinese werewolf_tetto_win_41ff77b5:

    # e "Where can I find him?"
    e ""

translate tranditional_chinese werewolf_tetto_win_f7e4afbb:
...
translate tranditional_chinese werewolf_tetto_win_d43a60eb_1:

    # "Tetto smiles."
    ""

translate tranditional_chinese werewolf_tetto_win_4ddba342:

    # tt "Oh, and speaking of the herbalist, there's something that I want to give you."
    tt ""

translate tranditional_chinese werewolf_tetto_win_b99fa1dc:

    # "The werewolf takes out a pair of old gloves, and put them on your hand."
    ""

translate tranditional_chinese werewolf_tetto_win_a252d62e:
...
translate tranditional_chinese werewolf_tetto_win_f1758625:

    # e "Thank you, Tetto."
    e ""

translate tranditional_chinese werewolf_tetto_win_47c16d24:

    # tt "Anyway, my brother is still sleeping like a baby now. His wound's recovered, I should make a bed around here soon."
    tt ""

translate tranditional_chinese werewolf_tetto_win_6a571956:

    # e "I guess we'll split here."
    e ""

translate tranditional_chinese werewolf_tetto_win_5ac1a863:

    # tt "Yep. May we meet again, [e]."
    tt ""

translate tranditional_chinese werewolf_tetto_win_5f051950:

    # e "Take care, Tetto."
    e ""

translate tranditional_chinese werewolf_tetto_win_06a2d283:

    # "Tetto raises his hand to wave you goodbye as you leave."
    ""

translate tranditional_chinese werewolf_tetto_lose_a1996fa6:

    # "The werewolves jeer, instead of the usual banters, you see actual bloodlust in their eyes."
    ""

translate tranditional_chinese werewolf_tetto_lose_30067e19:

    # "And soon you realise, it's the end of the journey."
    ""

translate tranditional_chinese werewolf_tetto_lose_50fe2d47:

    # "Without another second thought, the werewolf in front of you swings his claws one last time, hitting across your face."
    ""

translate tranditional_chinese werewolf_tetto_lose_55aed3f3:
...
translate tranditional_chinese werewolf_tetto_lose_685e948d:

    # "It was quicker than you thought, perhaps it was his unique method of showing mercy, your vision goes dark immediately."
    ""

translate tranditional_chinese werewolf_tetto_lose_6cf48d8f:
...
translate tranditional_chinese werewolf_tetto_lose_49d7d7a8:

    # tt "G-get off me! You monsters."
    tt ""

translate tranditional_chinese werewolf_tetto_lose_41871384:
...
translate tranditional_chinese werewolf_tetto_lose_5846ad61:

    # "Soon, you hear his brother is dragged away as well, leaving you alone on the forest floor."
    ""

translate tranditional_chinese werewolf_tetto_lose_1cd7638a:

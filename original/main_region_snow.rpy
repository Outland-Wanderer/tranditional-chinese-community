translate tranditional_chinese ursinia_glade_loop_3d7e1070:
...
translate tranditional_chinese ursinia_glade_loop_fbf1de00:
...
translate tranditional_chinese frosted_taiga_loop_8783b317:

    # e "I see... Were there someone else who could've been a better leader?"
    e ""

translate tranditional_chinese frosted_taiga_loop_bf123ac4:

    # bearGuard "Bedwyr, he's the best fighter we have in the tribe. But..."
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_cae5f7d9:

    # bearGuard "I believe I've said enough already."
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_4fd5f167:

    # bearGuard "Protecting the tribe, as always."
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_34cc99e4:

    # bearGuard "But, I've been thinking about getting a new armor from Methis, what do you think?"
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_d202f2f8:

    # e "Yours doesn't look that bad, but I think a new armor won't do any harm."
    e ""

translate tranditional_chinese frosted_taiga_loop_51e35880:
...
translate tranditional_chinese frosted_taiga_loop_1a295c6d:

    # e "Odd? How so?"
    e ""

translate tranditional_chinese frosted_taiga_loop_acef927d:
...
translate tranditional_chinese frosted_taiga_loop_b6a9e487:

    # e "Yeah, I guess so."
    e ""

translate tranditional_chinese frosted_taiga_loop_d43549bc:

    # bearGuard "Sometimes, when the midnight bell rings, when our shifts end, we hear noises behind the curtains in his shop."
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_fa6c57e2:

    # bearGuard "What magical mannequins works by the night... we never dared to ask, but I'm lying if I say we're not curious."
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_66f32a78:

    # "The guard chuckles, before continue on his journey."
    ""

translate tranditional_chinese frosted_taiga_loop_35263da6:

    # e "I'm just passing by, I'll be on my way."
    e ""

translate tranditional_chinese frosted_taiga_loop_2325223b:

    # bearGuard "Alright, but don't cause any trouble around here..."
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_4f9c54e4:

    # "You leave the bear guard behind and continue your journey."
    ""

translate tranditional_chinese frosted_taiga_loop_437288f2:

    # "It's only after a few seconds you can see that he's running towards your direction."
    ""

translate tranditional_chinese frosted_taiga_loop_8ebe2eab:

    # bearGuard "Outsider! Stop right here!"
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_2382c591:

    # e "Hey, I mean no harm."
    e ""

translate tranditional_chinese frosted_taiga_loop_1d10a48e:

    # bearGuard "By the name of our chief, I will kick you out of our territory once and for all." nointeract
    bearGuard "" nointeract

translate tranditional_chinese frosted_taiga_loop_cef234a5:

    # e "S-shit!"
    e ""

translate tranditional_chinese frosted_taiga_loop_2620f955:
...
translate tranditional_chinese frosted_taiga_loop_baf57d68:

    # bearGuard "Where do you think you're going, now fight me like a real bear."
    bearGuard ""

translate tranditional_chinese frosted_taiga_loop_cdebdd47:

    # "You run away from the guard, he tries to chase you but you barely manage to lose him in the snow."
    ""

translate tranditional_chinese frosted_taiga_loop_e91ba75d_1:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    ""

translate tranditional_chinese main_otsovaara_abyss_88d90385:
...
translate tranditional_chinese main_otsovaara_abyss_c5eeea40:
...
translate tranditional_chinese main_otsovaara_abyss_24419ecd:

    # "You pick up a piece of extra coal from the ground, it might be useful later."
    ""

translate tranditional_chinese main_otsovaara_abyss_90be6c5d:
...
translate tranditional_chinese main_finnkels_gaze_b72841d8:

    # "On the wall, a large deer head is mounted, its eyes seem to follow you wherever you go."
    ""

translate tranditional_chinese main_finnkels_gaze_865b162c:

    # e "That deer head on the wall, it's a bit creepy, don't you think?"
    e ""

translate tranditional_chinese main_finnkels_gaze_cb6287db:

    # m "Ah! Don't you worry your arse off, it's not a real deer. It's just a decoration."
    m ""

translate tranditional_chinese main_finnkels_gaze_42e14d91:

    # e "But why deers? Why not something else?"
    e ""

translate tranditional_chinese main_finnkels_gaze_60c673d2:
...
translate tranditional_chinese main_finnkels_gaze_ee114377:

    # e "Well, for one I might not want to imagine what a thousands years old scent smells like."
    e ""

translate tranditional_chinese main_finnkels_gaze_11eba957:

    # m "Oh, don't worry, I won't be pressing your little snout against these ice chunks anytime soon."
    m ""

translate tranditional_chinese main_finnkels_gaze_0cf6f430:

    # e "Uh... soon?"
    e ""

translate tranditional_chinese main_finnkels_gaze_d587b568:

    # m "Just kidding, don't worry about it."
    m ""

translate tranditional_chinese main_finnkels_gaze_de50b14f:
...
translate tranditional_chinese main_finnkels_gaze_f5d601b4:

    # e "Methis, what's with these mannequins?"
    e ""

translate tranditional_chinese main_finnkels_gaze_a65cc66b:

    # m "Did they scare you? They're just here to show off some of the wares we have in the shop."
    m ""

translate tranditional_chinese main_finnkels_gaze_4edb0d27:

    # e "Uh huh..."
    e ""

translate tranditional_chinese main_finnkels_gaze_4c6ac24f:

    # "Methis stares at you, waiting for you to say something."
    ""

translate tranditional_chinese main_finnkels_gaze_550a52c5:

    # m "Ah, sometimes they just couldn't stand still, they're a bit... lively, especially Kivy over there."
    m ""

translate tranditional_chinese main_finnkels_gaze_332753c8:

    # m "Say, I reckon the armors would look good on you, don't you think?"
    m ""

translate tranditional_chinese main_finnkels_gaze_932654fc:

    # "The shopkeeper chuckles, but you're not sure if he's joking or not."
    ""

translate tranditional_chinese main_finnkels_gaze_246b0251:

    # e "I'm not sure if I want to be wearing heavy armor in the middle of the snow."
    e ""

translate tranditional_chinese main_finnkels_gaze_d22e3cc3:

    # m "My assistants wouldn't look half as good in them as you would, heh."
    m ""

translate tranditional_chinese main_finnkels_gaze_27ff6015:
...
translate tranditional_chinese main_finnkels_gaze_fe17a6af:

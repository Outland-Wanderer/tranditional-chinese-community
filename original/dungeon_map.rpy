...
translate traditional_chinese Puro_Forest_Loop_6e2d6d2b:

    # "A strange, dragon-like skull. It's somewhat smaller than the folks back in your tribe."
    ""

translate traditional_chinese Puro_Forest_Loop_17259bc1:
...
translate traditional_chinese Puro_Forest_Loop_398a93ba:

    # "You can't drop the stone here."
    ""

translate traditional_chinese Puro_Forest_Loop_d235492a:

    # "You place the bone token into the hole on the egg-shaped altar."
    ""

translate traditional_chinese Puro_Forest_Loop_24f76e56:

    # "The token fits perfectly, and the altar glows faintly before going dim again."
    ""

translate traditional_chinese Puro_Forest_Loop_d235492a_1:

    # "You place the bone token into the hole on the egg-shaped altar."
    ""

translate traditional_chinese Puro_Forest_Loop_0e1a7ba7:

    # "The token fits perfectly, and the altar glows faintly."
    ""

translate traditional_chinese Puro_Forest_Loop_e7db83e4:

    # "The altar seems to be full now, and the glow becomes more apparent."
    ""

translate traditional_chinese Puro_Forest_Loop_b224f094:

    # "You can't drop the bone here."
    ""

translate traditional_chinese Puro_Forest_Spriteling_77faed7b:

    # "As you wander through the eerie forest, a soft glow materializes into a Spriteling."
    ""

translate traditional_chinese Puro_Forest_Spriteling_6957c94d:

    # "You can feel the cold air around you, as the Spriteling's presence becomes more apparent."
    ""

translate traditional_chinese Puro_Summoning_Spritebinder_2d966d51:

    # yu "Huh?"
    yu ""

translate traditional_chinese Puro_Summoning_Spritebinder_9c9e5503:

    # "The altar glows brighter and brighter, until the light becomes blinding."
    ""

translate traditional_chinese Puro_Summoning_Spritebinder_42787eba:

    # "A loud, otherworldly sound echoes through the forest, and you feel a sudden gust of wind."
    ""

translate traditional_chinese Puro_Summoning_Spritebinder_ce9d0a03:

    # "When the light fades, you find yourself standing in front of a strange, ethereal figure."
    ""

translate traditional_chinese Puro_Summoning_Spritebinder_bffdacf8:

    # "A hooded strange sprite, with too many pairs of arms, manifested itself before your eyes."
    ""

translate traditional_chinese Puro_Summoning_Spritebinder_48b3d209:

    # yu "What is this thing!"
    yu ""

translate traditional_chinese Puro_Summoning_Spritebinder_9fe2937b:

    # "It stares at you for a moment, before speaking in a voice that seems to come from everywhere at once."
    ""

translate traditional_chinese Puro_Summoning_Spritebinder_73241cc5:

    # yu "Shit!"
    yu ""

translate traditional_chinese Puro_Summoning_Spritebinder_433bad0c:

    # "Within a few seconds, it extends its arms towards you, and begins trying to grip onto you tightly."
    ""

translate traditional_chinese Puro_Summoning_Spritebinder_5f9014d9:

    # "You yank them away, and prepares to fight against this unknown entity."
    ""

translate traditional_chinese Puro_Watch_Post_Enter_89249e7f:
...
translate traditional_chinese Puro_Watch_Post_Loop_398a93ba:

    # "You can't drop the stone here."
    ""

translate traditional_chinese Puro_Watch_Post_Loop_1a3db160:

    # "An ordinary stone, maybe you can lift it up if you have the strength."
    ""

translate traditional_chinese Puro_Watch_Post_Loop_758c0011:

    # "You can't drop the turnip here."
    ""

translate traditional_chinese Damp_Cave_Enter_b33d9683:

    # k "You're back, are you prepared now."
    k ""

translate traditional_chinese Damp_Cave_Enter_c6f965f5:

    # k "I don't want to carry you out of the cave again."
    k ""

translate traditional_chinese Damp_Cave_Enter_239b9b42:

    # e "Yes, let's keep going."
    e ""

translate traditional_chinese Damp_Cave_Enter_38c18d0d:

    # k "I should have drafted my guards instead."
    k ""

translate traditional_chinese Damp_Cave_Enter_0e185163:

    # e "H-hey, I'm a good fighter..."
    e ""

translate traditional_chinese Damp_Cave_Enter_40e45012:

    # "The general stays silent, staring at you blankly."
    ""

translate traditional_chinese Damp_Cave_Enter_63b608f3:

    # e "I-I am!"
    e ""

translate traditional_chinese Damp_Cave_Enter_0af21bee:

    # e "Alright, General."
    e ""

translate traditional_chinese Damp_Cave_Enter_9f919637:

    # k "You're back."
    k ""

translate traditional_chinese Damp_Cave_Enter_d42aa91e:

    # e "Yes, let's continue with the cave."
    e ""

translate traditional_chinese Damp_Cave_Enter_40e45012_1:

    # "The general stays silent, staring at you blankly."
    ""

translate traditional_chinese Damp_Cave_Enter_6d7f824b:

    # k "I shouldn't wait for you."
    k ""

translate traditional_chinese Damp_Cave_Enter_6ab0a3b3:

    # e "Look we can save Furkan together, alright?"
    e ""

translate traditional_chinese Damp_Cave_Enter_9373df6d:

    # k "...if you go out one more time I'm going to kill you myself."
    k ""

translate traditional_chinese Damp_Cave_Enter_0af21bee_1:

    # e "Alright, General."
    e ""

translate traditional_chinese Damp_Cave_Enter_ad2473e1:

    # k "I did not intend to come back after such a long time."
    k ""

translate traditional_chinese Damp_Cave_Enter_ba6fd067:

    # e "Huh? Have you been here before?"
    e ""

translate traditional_chinese Damp_Cave_Enter_0010b313:

    # k "So did Furkan, this place was an ancient research post for the origin of the flowing water."
    k ""

translate traditional_chinese Damp_Cave_Enter_f6c42fbb:

    # k "Our guardians, the golems, were first created with the basin from here."
    k ""

translate traditional_chinese Damp_Cave_Enter_aba215cb:

    # e "Uh, what's a basin?"
    e ""

translate traditional_chinese Damp_Cave_Enter_ff324bbe:

    # k "Do you know nothing or what? A basin is a magical container, one that can hold the essence of the water."
    k ""

translate traditional_chinese Damp_Cave_Enter_dbace128:

    # e "Okay, you don't need to be mean about this. I am not from your tribe."
    e ""

translate traditional_chinese Damp_Cave_Enter_70545b86:

    # k "I'm not being mean, I'm just stating the fact."
    k ""

translate traditional_chinese Damp_Cave_Enter_e8e00549:

    # e "So, do you create guardians whenever you want?"
    e ""

translate traditional_chinese Damp_Cave_Enter_bf832a13:

    # k "No."
    k ""

translate traditional_chinese Damp_Cave_Enter_c9cbff4c:

    # k "You need to have the right gemstone."
    k ""

translate traditional_chinese Damp_Cave_Enter_9d2f2d12:

    # e "Alright."
    e ""

translate traditional_chinese Damp_Cave_Enter_bf0a4e1a:

    # k "Stop bickering now, let's go find Furkan, he should be around somewhere."
    k ""

translate traditional_chinese Damp_Cave_Loop_f78acfe3:

    # e "Furkan?"
    e ""

translate traditional_chinese Damp_Cave_Loop_959a8787:

    # f "Yeah, I'm still here, waiting for the guards."
    f ""

translate traditional_chinese Damp_Cave_Loop_3388a208:

    # e "Oh..."
    e ""

translate traditional_chinese Damp_Cave_Loop_afa99a7b:

    # e "I should go to the Goat Tribe now."
    e ""

translate traditional_chinese Damp_Cave_Loop_ed7b2a19:

    # "Furkan seems to be unconscious."
    ""

translate traditional_chinese Damp_Cave_Loop_67435228:

    # k "Courier, He's right there!"
    k ""

translate traditional_chinese Damp_Cave_Loop_2c2f1fc4:

    # e "Uhm? Oh... I see Furkan."
    e ""

translate traditional_chinese Damp_Cave_Loop_e9859b0e:

    # k "Yes, let's get this over with, Courier."
    k ""

translate traditional_chinese Damp_Cave_Loop_24b6d42e:

    # k "Kill the Guardian."
    k ""

translate traditional_chinese Damp_Cave_Loop_ceb7bdd4:

    # "You look at the Golem, who Kari told you was the rune guardian."
    ""

translate traditional_chinese Damp_Cave_Loop_e499e5e0:

    # "Furkan was behind him, unconscious..."
    ""

translate traditional_chinese Damp_Cave_Loop_3575c89a:

    # "You look at the Guardian, it seems to be standing here..."
    ""

translate traditional_chinese Damp_Cave_Loop_a0912840:

    # "There's an ordinary rock on the floor, Do you want to pick it up?"
    ""

translate traditional_chinese Damp_Cave_Loop_43a91da1:

    # "There's a mossy rock on the floor, it seems to be glowing weakly in blue... Do you want to pick it up?"
    ""

translate traditional_chinese Damp_Cave_Loop_54724ae6:

    # "There's a wooden plank on the floor, do you want to pick it up?"
    ""

translate traditional_chinese Damp_Cave_Loop_a920fd0e:

    # "You can't drop it here."
    ""

translate traditional_chinese Damp_Cave_Loop_a920fd0e_1:

    # "You can't drop it here."
    ""

translate traditional_chinese Damp_Cave_Loop_5183e1f6:

    # k "Wait, where are you going?"
    k ""

translate traditional_chinese Damp_Cave_Loop_07824b1e:

    # e "I, need to get something..."
    e ""

translate traditional_chinese Damp_Cave_Loop_38d2e2f4:

    # k "But you can't leave me here."
    k ""

translate traditional_chinese Damp_Cave_Loop_50401ba0:

    # k "Uhm."
    k ""

translate traditional_chinese Damp_Cave_Loop_48075da3:

    # k "Come back soon."
    k ""

translate traditional_chinese Damp_Cave_Loop_45d727e3:

    # e "A-alright. See you, General."
    e ""

translate traditional_chinese Damp_Cave_Loop_f291e002:

    # "You leave the dungeon through the exit tunnel, soon you reach the surface where you came from."
    ""

translate traditional_chinese Damp_Cave_Ward_9de74f29:

    # "You approach the stone ward in front of you, he doesn't seem to notice you."
    ""

translate traditional_chinese Damp_Cave_Ward_56c30d3f:

    # "But he also doesn't move..."
    ""

translate traditional_chinese Damp_Cave_Ward_f60aa64c:

    # "You jump in front of the stone ward, ready to battle with him."
    ""

translate traditional_chinese Damp_Cave_Mimic_d67d40f0:

    # "You run into a chest in the cave, you walk towards it, trying to open the chest."
    ""

translate traditional_chinese Damp_Cave_Mimic_e4a118d9:

    # "Suddenly the chest jumps right into your face, it's not a chest, it is a mimic."
    ""

translate traditional_chinese Damp_Cave_Mimic_384c5823:

    # "Mimic" "RAWAWWWR-"
    "Mimic" ""

translate traditional_chinese Damp_Cave_Mimic_68fd897f:

    # "You scream, its tongue is slithering out, trying to latch on you..."
    ""

translate traditional_chinese Damp_Cave_Mimic_2327a901:

    # k "W-what did you just do?"
    k ""

translate traditional_chinese Damp_Cave_Mimic_81773d81:

    # e "I d-don't know, let's kill it first!"
    e ""

translate traditional_chinese Damp_Cave_Mimic_5ee4de31:

    # k "A-alright."
    k ""

translate traditional_chinese Damp_Cave_Puddle_b1d48a69:

    # "You discover the puddle in the front."
    ""

translate traditional_chinese Damp_Cave_Puddle_e6835a9f:

    # "It seems to glowing in blue light but the water is stagnant..."
    ""

translate traditional_chinese Damp_Cave_Puddle_c56c97f0:

    # "You drank the water, it seems to have healed you to full health."
    ""

translate traditional_chinese Damp_Cave_Puddle_8bfbef95:

    # "But your Lust almost increased by 20."
    ""

translate traditional_chinese Damp_Cave_Puddle_feb65ab0:

    # e "Uhm... that made me feel so hot right now."
    e ""

translate traditional_chinese Damp_Cave_Puddle_ddbc5ca2:

    # k "W-what?"
    k ""

translate traditional_chinese Damp_Cave_Puddle_9b94ae94:

    # e "I drank the water."
    e ""

translate traditional_chinese Damp_Cave_Puddle_7d2893ae:

    # k "You drank from a dirty puddle on the ground, are you stupid?"
    k ""

translate traditional_chinese Damp_Cave_Puddle_7256839b:

    # e "Sorry..."
    e ""

translate traditional_chinese Damp_Cave_Puddle_d229b5e3:

    # "After drinking from the stagnant puddle, you decide to leave."
    ""

translate traditional_chinese Damp_Cave_Shelf_5a31dcf4:

    # e "Oh, there's a bookshelf here for some reason."
    e ""

translate traditional_chinese Damp_Cave_Shelf_2a8468ee:

    # "As you are searching around the bookshelf, you found out that most of the books are all unreadable..."
    ""

translate traditional_chinese Damp_Cave_Shelf_db731995:

    # "But after skimming through most of the shelf, there is a strip of paper that seems to be newer."
    ""

translate traditional_chinese Damp_Cave_Shelf_73e13418:

    # k "Uhm, What did it say...?"
    k ""

translate traditional_chinese Damp_Cave_Shelf_ba0eff63:

    # e "Let me see."
    e ""

translate traditional_chinese Damp_Cave_Shelf_16401e07:

    # "You read from the paper..."
    ""

translate traditional_chinese Damp_Cave_Shelf_2651c84d:

    # "'T/e blessi/g of Tapj/o: Date/ Year 12/07...'"
    ""

translate traditional_chinese Damp_Cave_Shelf_6442032d:

    # "'Accor/ding to the research by the King's a//isor, Kjarr Eli//.'"
    ""

translate traditional_chinese Damp_Cave_Shelf_9594d69a:

    # "'The recent explosion near Kechi//ren ({i}Goat Tr/be/{/i}, seems to /e caused by an unkn//n magi/al force.'"
    ""

translate traditional_chinese Damp_Cave_Shelf_ad6f399b:
...
translate traditional_chinese Damp_Cave_Shelf_cc4fb772:
...
translate traditional_chinese Damp_Cave_Shelf_7ac33039:

    # "'It is /nknown if ther/ exists any possible side effect.'"
    ""

translate traditional_chinese Damp_Cave_Shelf_c2ecef11:

    # "'For now, Goat Tri//'s Leader Goek/emir refused to cooperate with ou/ research team."
    ""

translate traditional_chinese Damp_Cave_Shelf_c6fa7ecc:

    # "The piece of paper gets cut off here."
    ""

translate traditional_chinese Damp_Cave_Shelf_8c89c538:

    # e "Uhm... what a weird piece of information. Who actually writes like that."
    e ""

translate traditional_chinese Damp_Cave_Shelf_97e6a665:

    # k "Is it talking about our Tribe?"
    k ""

translate traditional_chinese Damp_Cave_Shelf_92f16cc0:

    # e "Yeah."
    e ""

translate traditional_chinese Damp_Cave_Shelf_5baea47a:

    # k "Goekdemir is Furkan's Great-Grandfather, at least they got it right."
    k ""

translate traditional_chinese Damp_Cave_Shelf_a0961606:

    # k "Otherwise, I consider it nothing but gibberish. You should do so as well."
    k ""

translate traditional_chinese Damp_Cave_Shelf_1b5a6720:

    # e "Oh... It is."
    e ""

translate traditional_chinese Damp_Cave_Shelf_0e98079c:

    # "You put the piece of paper back to the bookshelf."
    ""

translate traditional_chinese Damp_Cave_Shelf_63bd4eda:

    # "You also discovered a recipe for a plain bandana among the books."
    ""

translate traditional_chinese Damp_Cave_Shelf_e246719a:

    # e "A plain bandana uses 2 fabric and 1 strap..."
    e ""

translate traditional_chinese Damp_Cave_Shelf_e254de6d:

    # "After looking into the books, you decide you have discovered everything readable."
    ""

translate traditional_chinese Damp_Cave_Chest_b9fb7400:

    # "You run into a chest in the cave, you walk towards it, trying to open it anything possible."
    ""

translate traditional_chinese Damp_Cave_Chest_4921e600:

    # "You discovered 100 gold, and 2 strength potions inside the chest."
    ""

translate traditional_chinese Damp_Cave_Chest_dee24fa2:

    # "You discovered 80 gold, 4 pieces of iron ingot and a recipe for canvas inside the chest."
    ""

translate traditional_chinese Damp_Cave_Chest_9f2e69f7:

    # e "To make a canvas, you need... 3 hemps and 2 straps, got it."
    e ""

translate traditional_chinese Damp_Cave_Chest_2b03842f:

    # e "Uhm... Kari? You want the stuff inside the chest?"
    e ""

translate traditional_chinese Damp_Cave_Chest_39c62512:

    # k "Keep it, Courier. I just want to save Furk."
    k ""

translate traditional_chinese Damp_Cave_Chest_ceca3aac:

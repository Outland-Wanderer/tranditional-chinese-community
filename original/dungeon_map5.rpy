translate tranditional_chinese Viscid_Stream_Loop_13bc34a0:

    # "The Chest seems to be locked... maybe there's some way to unlock it."
    ""

translate tranditional_chinese Viscid_Stream_Loop_a82cb1a4:

    # "The Chest is empty. There's nothing to be found now."
    ""

translate tranditional_chinese Viscid_Stream_Loop_cee136cf:

    # "You look inside the chest, there seem to be some items stored in the chest."
    ""

translate tranditional_chinese Viscid_Stream_Loop_2daa9371:

    # "You found a slime necklace, 2 pieces of iron and a green ointment."
    ""

translate tranditional_chinese Viscid_Stream_Loop_f5e4bfbd:

    # "You look at the scripture, it seems to be written in an entirely different language."
    ""

translate tranditional_chinese Viscid_Stream_Loop_e5203e12:

    # "You look at the scripture, there seem to be an aching aura surrounding you."
    ""

translate tranditional_chinese Viscid_Stream_Loop_442effc7:

    # "The ancient scripture is speaking to your mind directly..."
    ""

translate tranditional_chinese Viscid_Stream_Loop_45fe11ca:

    # "You hold both sides of your head, the pain in your head grows more unbearable."
    ""

translate tranditional_chinese Viscid_Stream_Loop_e4b12a18:

    # "Suddenly, the aching stops."
    ""

translate tranditional_chinese Viscid_Stream_Loop_208cec1f:

    # "You look around, nothing has changed, but your body feels weird."
    ""

translate tranditional_chinese Viscid_Stream_Loop_f6c64c6d:

    # "You look at the scripture again... it seems you've learnt a new skill."
    ""

translate tranditional_chinese Viscid_Stream_Loop_23cfcc65:

    # "{i}Resolution: Reduce your Lust based on your INT.{/i}"
    ""

translate tranditional_chinese Viscid_Stream_Loop_34be031e:

    # "You follow the dirt path in the Viscid Stream."
    ""

translate tranditional_chinese Viscid_Stream_Loop_bc68dbe3:

    # "There's a dense forest ahead of you, but you squeeze your body through tight spots here and there."
    ""

translate tranditional_chinese Viscid_Stream_Loop_855f77b4:

    # "After a few minutes, you've finally arrived to somewhere open."
    ""

translate tranditional_chinese Viscid_Stream_Loop_985f7add:

    # "You've arrived to another riverside area. Maybe there's something you can find here..."
    ""

translate tranditional_chinese Viscid_Stream_Loop_549aa4af:

    # "The door seems to be barred from the other side..."
    ""

translate tranditional_chinese Viscid_Stream_Loop_f4239549:

    # "You push the horizontal plank upwards. The door is now unlocked."
    ""

translate tranditional_chinese Viscid_Stream_Loop_34be031e_1:

    # "You follow the dirt path in the Viscid Stream."
    ""

translate tranditional_chinese Viscid_Stream_Loop_bc68dbe3_1:

    # "There's a dense forest ahead of you, but you squeeze your body through tight spots here and there."
    ""

translate tranditional_chinese Viscid_Stream_Loop_855f77b4_1:

    # "After a few minutes, you've finally arrived to somewhere open."
    ""

translate tranditional_chinese Viscid_Stream_Loop_bf28d22e:

    # "You notice there's a hint of white rock in front of you... it looks... like an abandoned sanctuary..."
    ""

translate tranditional_chinese Viscid_Stream_Loop_f6de1db2:

    # "You enter the viscid stream."
    ""

translate tranditional_chinese Viscid_Stream_Hefty_a1f40dc4:

    # "The big slime begins approaching you..."
    ""

translate tranditional_chinese Viscid_Stream_Hefty_626b8d70:

    # e "F-fuck, that's bigger than in the green forest..."
    e ""

translate tranditional_chinese Creek_Thicket_Loop_9d24fed9:

    # "You peek at the small creature inside the bush."
    ""

translate tranditional_chinese Creek_Thicket_Loop_25826baa:

    # "It seems to be quite friendly towards your presence, despite the infestation of slime around the forest."
    ""

translate tranditional_chinese Creek_Thicket_Loop_dd751c66:

    # "It seems to be a little too excited to see the slimes gone from the area."
    ""

translate tranditional_chinese Creek_Thicket_Loop_66d2bb1e:

    # "You snoop around its place, you realise there's a few items it's been hoarding for a while."
    ""

translate tranditional_chinese Creek_Thicket_Loop_220d6f03:

    # "The little guy seems to be curious about you items too... perhaps you can come to an agreement or some sort..."
    ""

translate tranditional_chinese Creek_Thicket_Loop_209b8f2a:

    # "It was too dark to properly see the little guy, and it seems to be too scared to come out."
    ""

translate tranditional_chinese Creek_Thicket_Loop_e396f693:

    # "Only staring at huge slime in fright..."
    ""

translate tranditional_chinese Creek_Thicket_Loop_11bdcf7c:

    # "Maybe you need to... defeat all the slime in the area to comfort it a little."
    ""

translate tranditional_chinese Creek_Thicket_Loop_416421c5:

    # "You pick up the book..."
    ""

translate tranditional_chinese Creek_Thicket_Loop_261d3896:

    # booky "{i}'Botanical Journal of Plants In and Around the Dark Forest: Species, Uses, and Dangers.'\n {b}-y W—t-r A-z-var- {/b}{/i}"
    booky ""

translate tranditional_chinese Creek_Thicket_Loop_9537f04c:
...
translate tranditional_chinese Creek_Thicket_Loop_c0e0b0a6:

translate traditional_chinese Forgotten_Sanctuary_Loop_647b2f69:

    # "Yet another page is on the ground."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_7aee958a:

    # "There is nothing that immediately pops out to you."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_20723338:

    # "You have nowhere to store this page in. For now, you'll have to leave it where it is."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_d72842ac:

    # "You've already picked up the book. There's no reason not to fill it out."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_23b5c3fa:
...
translate traditional_chinese Forgotten_Sanctuary_Loop_2989e75f:

    # "Now that you have everything organized, you start to read the new fragment."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_3aab505a:

    # "There is a short gap in the writing, as if the author was unsure of what to say."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_68e3866a:

    # msg "New Page has been added to the Book."
    msg ""

translate traditional_chinese Forgotten_Sanctuary_Loop_18aa8f13:

    # "It's for the best if you leave it here for now - it's been preserved up until now, why disturb it."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_db40e2e2:

    # "You walk through the door, there seem to be a huge... slime right in front of you..."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_db40e2e2_1:

    # "You walk through the door, there seem to be a huge... slime right in front of you..."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_754b1c21:

    # "You walk through the back of the shrine... A huge slime, almost twice your height, appears in front of you."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_989acebc:

    # "Instead of merely a ball shaped goo, this... this one has arms extruded in front of it..."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_c52db4fd:

    # "You take a look at the note in front of you, it seems to be left here by a werewolf."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_ec9e3574:

    # "The sign describes the plate puzzle in front of you in a symbolic manner."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_c2e1afa6:

    # "The plate buttons seem to suggest a certain pattern and sequence that you have to walk over..."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_45dc76a1:

    # "And the catch is, the adventurer cannot step on the same square twice."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_6e3c9d1e:

    # "Finishing the puzzle unlocks a door in which leads to where slimes reside."
    ""

translate traditional_chinese Forgotten_Sanctuary_Loop_8b5effca:

    # "You leave the forgotton sanctuary along the path ahead of you."
    ""

translate traditional_chinese Forgotten_Sanctuary_Hefty_a1f40dc4:

    # "The big slime begins approaching you..."
    ""

translate traditional_chinese Forgotten_Sanctuary_Hefty_a17bddd2:

    # e "F-fuck, that's bigger than those in the green forest..."
    e ""

translate traditional_chinese Whispering_Hollow_Loop_16c08970:

    # "You hear a wooden clank sound from afar, it seems something has opened."
    ""

translate traditional_chinese Whispering_Hollow_Loop_1c02c8e5:

    # "You run into a chest in the forest, you walk towards it, trying to open the chest."
    ""

translate traditional_chinese Whispering_Hollow_Loop_e4a118d9:

    # "Suddenly the chest jumps right into your face, it's not a chest, it is a mimic."
    ""

translate traditional_chinese Whispering_Hollow_Loop_384c5823:

    # "Mimic" "RAWAWWWR-"
    "Mimic" ""

translate traditional_chinese Whispering_Hollow_Loop_68fd897f:

    # "You scream, its tongue is slithering out, trying to latch on you..."
    ""

translate traditional_chinese Whispering_Hollow_Loop_8f4b5a9c:

    # ww "Hey, dude. Guess what, Uffe doesn't let me return to our den."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_4e7ff085:

    # e "That's a bummer."
    e ""

translate traditional_chinese Whispering_Hollow_Loop_3cbaec72:

    # ww "Yeah, yeah."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_8fda86e4:

    # "The werewolf continues watching over the empty hollow."
    ""

translate traditional_chinese Whispering_Hollow_Loop_1b037ac5:

    # ww "Oh... damn. You've done it."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_69b862df:

    # ww "Turns out, what I need to put there is in my pocket all along!"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_0029ca51:

    # "The werewolf reveals a piece of iron from his loincloth."
    ""

translate traditional_chinese Whispering_Hollow_Loop_1b78a4f9:

    # ww "I was going to solve it so easily, if only all of the answers were meat, hmmm..."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_43ca3024:

    # e "Yeah, guess I'm going back to Uffe with the amulet."
    e ""

translate traditional_chinese Whispering_Hollow_Loop_0c6e7e10:

    # ww "Good luck, dude."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_ca52a0cf:

    # ww "Oh, and remember to clear the shrubs. We're going to hunt down much more preys here."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_2255f5d6:

    # "He waves you a farewell, before sitting lazily."
    ""

translate traditional_chinese Whispering_Hollow_Loop_5f7b93b1:

    # "You notice a huge werewolf peeking by the side of the hollow."
    ""

translate traditional_chinese Whispering_Hollow_Loop_ba53a226:

    # "He looks worried, to say the least. Not overly aggressive like the others."
    ""

translate traditional_chinese Whispering_Hollow_Loop_581629cf:

    # ww "Oh?"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_dde308d5:

    # "The werewolf notices you."
    ""

translate traditional_chinese Whispering_Hollow_Loop_01491e7b:

    # ww "Uffe sent you?"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_18967a55:

    # e "Uhm... yes. I was worried you're going to attack me."
    e ""

translate traditional_chinese Whispering_Hollow_Loop_eaf21e66:

    # ww "N-no. We don't have time for that."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_92db29ba:

    # "Both of you remain silent for a minute, as the werewolf removes his gaze on you."
    ""

translate traditional_chinese Whispering_Hollow_Loop_fdcb1662:

    # "He takes another glance at the paper, and looks over the hollow."
    ""

translate traditional_chinese Whispering_Hollow_Loop_10fe600a:

    # ww "Fuck, man. Why do we even bother with this thing."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_74cdafb0:
...
translate traditional_chinese Whispering_Hollow_Loop_7429056a:

    # "He finishes the riddle with a loud sigh."
    ""

translate traditional_chinese Whispering_Hollow_Loop_e9bd0086:

    # ww "W-what can it be? We've spent a whole week over this, maybe it's food, or... meat? That's not right."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_c4089a3e:

    # ww "Or..."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_d3066dc2:

    # ww "Maybe it's food! Y-yes. Food. W-wait a minute..."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_c0becb45:

    # "The werewolf falls into another period of pondering, you decide to leave him alone, and inspect the pillars."
    ""

translate traditional_chinese Whispering_Hollow_Loop_5f7b93b1_1:

    # "You notice a huge werewolf peeking by the side of the hollow."
    ""

translate traditional_chinese Whispering_Hollow_Loop_d2edc994:

    # ww "W-what can that mean? Hard and Unyielding... My cock can be like that, maybe not {i}honed to a deadly point.{/i}"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_ade48d60:

    # ww "Wouldn't make sense to {i}till the land{/i} also."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_85d2bd74:

    # ww "But I can put my cock on the pillar, it'll probably fit."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_06eefad7:

    # "Yes, that would not make sense, as you thought."
    ""

translate traditional_chinese Whispering_Hollow_Loop_e04bf7d7:

    # ww "Oh hey! The amulet is right there! How did you do that?"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_16c35601:

    # ww "Wait, the beasts of the night, isn't that... us?"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_0813b5d5:

    # ww "Why would they repel us, must be something from the tasty goats again..."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_5b5e3936:

    # ww "They could have something there up their slippery sleeves."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_c2de7c62:

    # ww "Whisper that brushes, sounds like my fur. Mine's delicate also."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_42c1113e:

    # ww "My cock's... uh... more like a howl. But... dances with the wind?"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_097aaf9d:

    # ww "Stop being poetic! This is getting me so angry I can tear a bird in half!"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_c0eb9969:

    # ww "Chime... gentle? That sounds so obvious, it's the fuckin' bear's horn, right?"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_b76295a5:

    # ww "That gives me shivers every time they try that across the mountains from here."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_ae7aef8a:

    # ww "But seriously, where can I get a horn, from somwhere that's close enough, preferably a prey?"
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_c3bdd561:

    # ww "Warmth, bones. Sounds like a proper feast in my pack. the only thing missing is the meat."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_fbc48ab5:

    # ww "But meat's not bitter, and it's a drink. Doesn't sound like something we have... unless we're talking about blood."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_0ba2839c:

    # ww "Though, what did we drink in the feast? We always had that at full moon, Can't bring myself to remember that stuff."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_5e281fac:

    # ww "Hard and Unyielding..."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_562a271e:

    # ww "...What if it's something from the ground? We've had that in the mines before..."
    ww ""

translate traditional_chinese Whispering_Hollow_Loop_7031d355:

    # "You leave the werewolf alone to his thought once again."
    ""

translate traditional_chinese Whispering_Hollow_Loop_63639cea:

    # "After cutting through the last shrub, it seems you've cleared the area."
    ""

translate traditional_chinese Whispering_Hollow_Loop_73cc25dc:

    # "The Pillar says..."
    ""

translate traditional_chinese Whispering_Hollow_Loop_a5a943bb:
...
translate traditional_chinese Whispering_Hollow_Loop_73cc25dc_1:

    # "The Pillar says..."
    ""

translate traditional_chinese Whispering_Hollow_Loop_ebf519a8:
...
translate traditional_chinese Whispering_Hollow_Loop_73cc25dc_2:

    # "The Pillar says..."
    ""

translate traditional_chinese Whispering_Hollow_Loop_8866c5d2:
...
translate traditional_chinese Whispering_Hollow_Loop_73cc25dc_3:

    # "The Pillar says..."
    ""

translate traditional_chinese Whispering_Hollow_Loop_bbe8d806:
...
translate traditional_chinese Whispering_Hollow_Loop_73cc25dc_4:

    # "The Pillar says..."
    ""

translate traditional_chinese Whispering_Hollow_Loop_ae841a1c:
...
translate traditional_chinese Whispering_Hollow_Loop_e741ea35:

    # "The broken pillar next to you begin to glow."
    ""

translate traditional_chinese Whispering_Hollow_Loop_66cd190b:

    # "As you blink, an amulet suddenly appears out of thin air on top of the stone pillar."
    ""

translate traditional_chinese Whispering_Hollow_Loop_3c6a1d54:

    # "You stare at the broken pillar, there seems to be an aura of magic inside it that's pulling your life force in..."
    ""

translate traditional_chinese Whispering_Hollow_Loop_c347dea6:

    # "There are 5 holes at the center of the broken pillar, and [whillar_score] of them are dimly lit."
    ""

translate traditional_chinese Whispering_Hollow_Loop_96741bae:

    # "It seems that something will happen here, if all five lights are ignited."
    ""

translate traditional_chinese Whispering_Hollow_Loop_9a7de3e2:

    # "You retreat from the pillar."
    ""

translate traditional_chinese Whispering_Hollow_Loop_41385b01:

    # "You read the dim paragraph on the pillar."
    ""

translate traditional_chinese Whispering_Hollow_Loop_03a96509:
...
translate traditional_chinese Whispering_Hollow_Loop_6466610a:

    # "Without the amulet, all that's left in the pillar is its own self..."
    ""

translate traditional_chinese Whispering_Hollow_Loop_c2564626:

    # "You read the shining paragraph on the pillar."
    ""

translate traditional_chinese Whispering_Hollow_Loop_03a96509_1:

    # "{i}I am a moonstone of werewolf might, a symbol of strength in the fight.{w}{p}But to harness my true power and glory, the price of sacrifice must be your story.{/i}"
    ""

translate traditional_chinese Whispering_Hollow_Loop_274aba80:

    # "It fades soon after, leaving only the amulet on top of the pillar."
    ""

translate traditional_chinese Whispering_Hollow_Loop_884f0b56:

    # "You snatch the moonstone amulet from its light, and put it in your bag."
    ""

translate traditional_chinese Whispering_Hollow_Loop_0966c114:

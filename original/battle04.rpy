...
translate traditional_chinese werewolf_battle_loop_45a9fad8:

    # "Your lust increased by [enemy_flirt]."
    ""

translate traditional_chinese werewolf_battle_loop_a37a5cba:

    # "You are stunned by his gorgeous muscles, you mind wanders through scenarios of him being inside your body."
    ""

translate traditional_chinese werewolf_battle_loop_45a9fad8_1:

    # "Your lust increased by [enemy_flirt]."
    ""

translate traditional_chinese werewolf_battle_loop_2cb0c85f:
...
translate traditional_chinese werewolf_lose_3a3f9013:
...
translate traditional_chinese werewolf_lose_3d9e673f:
...
translate traditional_chinese werewolf_lose_eceaf863:

    # ww "Uffe's gotta love this one, heh."
    ww ""

translate traditional_chinese werewolf_lose_c7fb321b:

    # "As you wake up, a familiar face greets you from above, someone that you know, but never wants to meet again."
    ""

translate traditional_chinese werewolf_lose_a20cefa7:

    # "..."
    ""

translate traditional_chinese werewolf_lose_a0930d76:

    # "You lost [lost_gold] Gold."
    ""

translate traditional_chinese scarecrow_battle_aeb8509d:

    # "You raise your fist against the scarecrow, it seems to be standing in solitude, only turning back at you in confusion."
    ""

translate traditional_chinese scarecrow_battle_ba4dff45:
...
translate traditional_chinese scarecrow_battle_loop_188f5c92:
...
translate traditional_chinese scarecrow_battle_loop_7b4ac4a3:

    # "The scarecrow looks at you... it's still looking at you unfazed, except the head tilt..."
    ""

translate traditional_chinese scarecrow_battle_loop_1a68a0b3:
...
translate traditional_chinese landshark_battle_loop_d5598c9f:

    # "The landshark jumps up from below and strikes on your body, he draining [enemy_damage] HP from you."
    ""

translate traditional_chinese landshark_battle_loop_71f9875c:
...
translate traditional_chinese landshark_battle_loop_7e90b3f2:

    # "The landshark dives at you, hitting you with a strong bite. Your health decreases by [enemy_damage] HP."
    ""

translate traditional_chinese landshark_battle_loop_d0e806bc:

    # "The landshark swings his left fin towards you, but you managed to deflect his attack."
    ""

translate traditional_chinese landshark_battle_loop_56f7bbee:

    # "The landshark charges at you, trying to feast on you but you block the blow and push him away."
    ""

translate traditional_chinese landshark_battle_loop_a138765a:

    # "The landshark dives under the soil... seems like his next attack can be dangerous."
    ""

translate traditional_chinese landshark_battle_loop_f2a8c880:

    # "The landshark roars, and reduces your MP by 20."
    ""

translate traditional_chinese landshark_win_27b6b3e8:

    # "As you defeat the landshark, it begins to collapse and fall into a spiral underground..."
    ""

translate traditional_chinese landshark_win_e92d4827:

    # "There's nothing useful for now..."
    ""

translate traditional_chinese landshark_win_b34e8987:

    # "You found [gold_drop] gold and [exp_drop] EXP."
    ""

translate traditional_chinese landshark_win_de023e00:

    # "You pick up a longsword from the where the landshark lands, it seems almost brand new."
    ""

translate traditional_chinese landshark_win_025b0b55:

    # "You pick up a piece of clay..."
    ""

translate traditional_chinese landshark_win_91f1d522:

    # msg "You are now Level [pc.level]! Check your inventory to allocate your level points."
    msg ""

translate traditional_chinese landshark_lose_1a2c0718:

    # "The landshark swims around you, it seems to be ready to feast on you... but he didn't..."
    ""

translate traditional_chinese landshark_lose_40537635:

    # "He dives right before the scarecrow in the farm spots him."
    ""

translate traditional_chinese landshark_lose_4ba96869:

    # "You lost [gold_lost] gold."
    ""

translate traditional_chinese ratbandit_battle_74af631b:
...
translate traditional_chinese ratbandit_battle_fb9c8185:
...
translate traditional_chinese ratbandit_battle_loop_b770443e:
...
translate traditional_chinese ratbandit_battle_loop_9372f5e5:
...
translate traditional_chinese ratbandit_battle_loop_d49fcdeb:
...
translate traditional_chinese ratbandit_battle_loop_63ca8138:

    # "You aim and shoot your [pc.weapon.name!t] at the rat, the arrow hit right into his shoulder."
    ""

translate traditional_chinese ratbandit_battle_loop_64450b04:
...
translate traditional_chinese ratbandit_battle_loop_04ec1408:

    # "You throw your fist at the rat, hitting him right across his face, the sheer impact knocks him on the ground."
    ""

translate traditional_chinese ratbandit_battle_loop_5fc11c2d:

    # "You punch into the rat's stomach, grabbing him and slam him on the ground hard."
    ""

translate traditional_chinese ratbandit_battle_loop_24bcc736:

    # "His health decreases by [oa[4]] HP."
    ""

translate traditional_chinese ratbandit_battle_loop_17a649f0:

    # "You've critically hit the bandit, dealing [oa[4]] HP!"
    ""

translate traditional_chinese ratbandit_battle_loop_f58127ce:

    # rbd "Argh! I haven't been hit for a long time!"
    rbd ""

translate traditional_chinese ratbandit_battle_loop_8b58beea:

    # rbd "What's the thing that made you aim that well. That's impossible!"
    rbd ""

translate traditional_chinese ratbandit_battle_loop_409a4a3d:

    # rbd "e-eeeek...! You're not going to hit me twice in a row!"
    rbd ""

translate traditional_chinese ratbandit_battle_loop_850f80c2:

    # rbd "fffff- I have to get out of this soon."
    rbd ""

translate traditional_chinese ratbandit_battle_loop_fdf9de27:
...
translate traditional_chinese ratbandit_battle_loop_ea17c91d:
...
translate traditional_chinese ratbandit_battle_loop_73a3b51a:
...
translate traditional_chinese ratbandit_battle_loop_1fd87d43:

    # "You continue your act for about a minute, but the bandit doesn't even flinch."
    ""

translate traditional_chinese ratbandit_battle_loop_26bf6beb:

    # rbd "Well..."
    rbd ""

translate traditional_chinese ratbandit_battle_loop_418a221b:
...
translate traditional_chinese ratbandit_battle_loop_a8f3880c:

    # rbd "...I-if you do this one more time I'm going to grab that huge ass and never let you go..."
    rbd ""

translate traditional_chinese ratbandit_battle_loop_ae30f3f4:
...
translate traditional_chinese ratbandit_battle_loop_af62cd2a:

    # rbd "You are w-wasting your time. I'm n-not... I'm not... I- uhh... nooo..."
    rbd ""

translate traditional_chinese ratbandit_battle_loop_34befdba:
...
translate traditional_chinese ratbandit_battle_loop_fe4a1e82:

    # rbd "N-noooo... I'm not- h-horny!"
    rbd ""

translate traditional_chinese ratbandit_battle_loop_e9df915d:
...
translate traditional_chinese ratbandit_battle_loop_d32212bc:

    # rbd "Heh, this is what precision looks like."
    rbd ""

translate traditional_chinese ratbandit_battle_loop_365ff672:
...
translate traditional_chinese ratbandit_battle_loop_0b1f2116:

    # "You stare at him, giving him weird side eyes. You have evaded his attempt at seduction."
    ""

translate traditional_chinese ratbandit_battle_loop_9b3dd47a:
...
translate traditional_chinese ratbandit_battle_loop_86aaba75:

    # rbd "Take a look at this, well you get to touch it if you promise not to chase after me ever again."
    rbd ""

translate traditional_chinese ratbandit_battle_loop_21bad776:
...
translate traditional_chinese ratbandit_battle_loop_05b754b3:

    # "His attack at your lust seems to have failed as you stand there and wait for him to finish his taunt."
    ""

translate traditional_chinese ratbandit_battle_win_fba0026d:

    # "The thief slumps on the ground, he's too exhausted to escape from your grasp."
    ""

translate traditional_chinese ratbandit_battle_win_e7256a2b:

    # rbd "D-damn it. A-alright you caught me..."
    rbd ""

translate traditional_chinese ratbandit_battle_win_ed577e51:

    # e "Y-yeah you were an ass to get a hold of."
    e ""

translate traditional_chinese ratbandit_battle_win_678036cd:

    # e "Why did you take the plums?"
    e ""

translate traditional_chinese ratbandit_battle_win_0bb2474b:

    # rbd "My boss wanted those, I needed to impress him after failing him last time."
    rbd ""

translate traditional_chinese ratbandit_battle_win_36fa1718:

    # e "But the plums are ours. Give me back those and maybe you can- leave."
    e ""

translate traditional_chinese ratbandit_battle_win_5236c44b:

    # rbd "He's going to kill me if I don't give him back the plums."
    rbd ""

translate traditional_chinese ratbandit_battle_win_78454438:

    # rbd "I mean like, kill."
    rbd ""

translate traditional_chinese ratbandit_battle_win_72a33094:

    # e "..."
    e ""

translate traditional_chinese ratbandit_battle_win_b538aa04:

    # rbd "Like, death. Dude."
    rbd ""

translate traditional_chinese ratbandit_battle_win_209707be:

    # e "Uh..."
    e ""

translate traditional_chinese ratbandit_battle_win_7074e504:

    # "The thief gestures his hand over his neck. You're not sure if you should trust him or not."
    ""

translate traditional_chinese ratbandit_battle_win_febe0f49:

    # rbd "Dude, I promise I won't come back again."
    rbd ""

translate traditional_chinese ratbandit_battle_win_9b38733e:

    # e "Why would you even come here without thinking about getting caught?"
    e ""

translate traditional_chinese ratbandit_battle_win_ca9dc569:

    # rbd "I don't know, I thought I was safe because of the hyena."
    rbd ""

translate traditional_chinese ratbandit_battle_win_3b7861ce:

    # e "Hyena?"
    e ""

translate traditional_chinese ratbandit_battle_win_03d02605:

    # rbd "Yeah, boss told me the hyena takes care of the farm."
    rbd ""

translate traditional_chinese ratbandit_battle_win_9ec97e8e:

    # e "Are you talking about Jog? Do you know him?"
    e ""

translate traditional_chinese ratbandit_battle_win_a93d270f:

    # rbd "The small one, he was one of us long time ago. boss said if I- I- don't follow him I'd end up like the hyena..."
    rbd ""

translate traditional_chinese ratbandit_battle_win_b72c48ed:

    # e "Why are you implying he's doing worse than you are right now."
    e ""

translate traditional_chinese ratbandit_battle_win_b63611cd:

    # rbd "...well. I don't know."
    rbd ""

translate traditional_chinese ratbandit_battle_win_dad2d676:

    # "You remain silent, the rodent thief doesn't feel as easy as you do right now."
    ""

translate traditional_chinese ratbandit_battle_win_633b6cbc:

    # rbd "That's all I can tell you, dude. Please just let me take the plum and I won't bother your farm again."
    rbd ""

translate traditional_chinese ratbandit_battle_win_67680fee:

    # "If the rat's telling the truth, not returning the plum basically means death sentence to him..."
    ""

translate traditional_chinese ratbandit_battle_win_89a2c038:

    # "On the other hand, you'd love to impress Jog by getting back the plums."
    ""

translate traditional_chinese ratbandit_battle_win_76391e0c:

    # "You know the shark doesn't kill anyone as easily as the rat proclaims."
    ""

translate traditional_chinese ratbandit_battle_win_8c68c8a6:

    # "But perhaps it can divert some suspicion away from you, what if the rat reports to the shark that a goat was there."
    ""

translate traditional_chinese ratbandit_battle_win_78180bf1:

    # "And his boss connects the dots?"
    ""

translate traditional_chinese ratbandit_battle_win_cfed4921:

    # "Even though you don't know what Jog has to do with the thieves."
    ""

translate traditional_chinese ratbandit_battle_win_5f8eca33:

    # "Was he always working for the bandit? Surely he won't betray everyone's trust for the bandit boss."
    ""

translate traditional_chinese ratbandit_battle_win_45c1ff4e:

    # "Or, maybe he was just a former one, who abandoned his bandit life to live in Lusterfield."
    ""

translate traditional_chinese ratbandit_battle_win_5904a505:

    # "You're not sure. But you need to make a choice here."
    ""

translate traditional_chinese ratbandit_battle_win_6c3bfcd1:

    # e "Hmmph...." nointeract
    e "" nointeract

translate traditional_chinese ratbandit_battle_win_f3cce2a7:

    # e "N-no. I can't risk getting you to come back."
    e ""

translate traditional_chinese ratbandit_battle_win_e45ce0ed:

    # rbd "D-dude. Please. I-I can't go back empty-handed."
    rbd ""

translate traditional_chinese ratbandit_battle_win_f338fa4e:

    # rbd "M-my boss is goin-"
    rbd ""

translate traditional_chinese ratbandit_battle_win_7572becd:

    # e "No. Get your stuff and leave. And do not come back."
    e ""

translate traditional_chinese ratbandit_battle_win_2626caaf:

    # rbd "You're so cruel, dude."
    rbd ""

translate traditional_chinese ratbandit_battle_win_5f94acdb:

    # e "One more whine and you're not leaving this place."
    e ""

translate traditional_chinese ratbandit_battle_win_c1f9eff3:

    # rbd "O-ok. You're bad at scaring me but I'll do whatever you want."
    rbd ""

translate traditional_chinese ratbandit_battle_win_d1bc523f:

    # rbd "The plums are over there."
    rbd ""

translate traditional_chinese ratbandit_battle_win_a045637e:

    # "He points at the small dirt lump a few steps next to him."
    ""

translate traditional_chinese ratbandit_battle_win_ed33de26:

    # rbd "A-and I'll be going."
    rbd ""

translate traditional_chinese ratbandit_battle_win_6d1d2645:

    # "You watch silently as the thief gets up, and runs away from your sight."
    ""

translate traditional_chinese ratbandit_battle_win_f068141e:

    # "He quickly disappear, leaving you with the lump of plums."
    ""

translate traditional_chinese ratbandit_battle_win_8104b88f:

    # "You dig the fruits up with your hand and soon return to the garden."
    ""

translate traditional_chinese ratbandit_battle_win_09bd14fa:

    # e "Uhh, keep it. But if the others and I see your face again here, you're never going back to your boss."
    e ""

translate traditional_chinese ratbandit_battle_win_44186519:

    # rbd "Y-yes, ok. Thank you. I'll remember this."
    rbd ""

translate traditional_chinese ratbandit_battle_win_578a88cb:

    # "The rat scrambles to run a few steps towards a lump in the ground. He begins digging down with his hands."
    ""

translate traditional_chinese ratbandit_battle_win_d872786e:

    # "He uncovers some plums that he had been hiding right there."
    ""

translate traditional_chinese ratbandit_battle_win_eb4f2818:

    # rbd "I'll be on my way! Thanks."
    rbd ""

translate traditional_chinese ratbandit_battle_win_d481d527:

    # e "Go now."
    e ""

translate traditional_chinese ratbandit_battle_win_88243c5e:

    # "You stare at the agile bandit with hands full of plums, he waves back at you."
    ""

translate traditional_chinese ratbandit_battle_win_3e584ea6:

    # "Soon, the thief disappears into the grasses again."
    ""

translate traditional_chinese ratbandit_battle_win_f1d5bcf7:

    # "Despite returning empty-handed, at least you know the plums are safe again."
    ""

translate traditional_chinese ratbandit_battle_win_ee9950ed:

    # "Perhaps you also did the thief a favour, knowing he won't get into trouble with his boss."
    ""

translate traditional_chinese ratbandit_battle_lose_a1e6bd2e:

    # "You are too exhausted to fight back against the rat."
    ""

translate traditional_chinese ratbandit_battle_lose_878da57e:

    # "Your cock is pumping, filled with lust over the flirtation the rat has been showering you."
    ""

translate traditional_chinese ratbandit_battle_lose_b1e6bda8:

    # rbd "Alright, let's make this quick."
    rbd ""

translate traditional_chinese ratbandit_battle_lose_5179b8df:

    # "He swindles [lost_gold] out of your pocket."
    ""

translate traditional_chinese ratbandit_battle_lose_0586692a:

    # rbd "And I get to keep my plums. That's the best deal I've ever seen."
    rbd ""

translate traditional_chinese ratbandit_battle_lose_0e5b379c:

    # "The thief doesn't even give you another glance, he just whistles his way out of the farm."
    ""

translate traditional_chinese ratbandit_battle_lose_48119688:

    # "Your consciousness fades."
    ""

translate traditional_chinese ratbandit_battle_lose_600c41a1:

    # ar "-Pup?"
    ar ""

translate traditional_chinese ratbandit_battle_lose_0a819188:

    # "At some point, you wake up with Arthur glaring over you."
    ""

translate traditional_chinese ratbandit_battle_lose_43e8eace:

    # ar "You looking rough here, feeling any body parts missing?"
    ar ""

translate traditional_chinese ratbandit_battle_lose_3c6198c1:

    # e "N-no, I- I just let the thief slip away."
    e ""

translate traditional_chinese ratbandit_battle_lose_c765ad5f:

    # ar "That cunning son of a thief must have been a bitch to handle."
    ar ""

translate traditional_chinese ratbandit_battle_lose_f5907f9f:

    # ar "Good, thought you're just too excited to see me with the bulge down there."
    ar ""

translate traditional_chinese ratbandit_battle_lose_5fefc0cb:

    # "You blush intensely."
    ""

translate traditional_chinese ratbandit_battle_lose_f5b20f6a:

    # ar "Look, got you some potions while you were passed out, should feel better now."
    ar ""

translate traditional_chinese ratbandit_battle_lose_d293759c:

    # "You slowly get up from the grass ground."
    ""

translate traditional_chinese ratbandit_battle_lose_72dbaadc:

    # e "T-thanks, Master."
    e ""

translate traditional_chinese ratbandit_battle_lose_52a25070:

    # e "Thanks, Arthur."
    e ""

translate traditional_chinese ratbandit_battle_lose_994b12eb:

    # "He smiles."
    ""

translate traditional_chinese ratbandit_battle_lose_4dd8fdcb:

    # ar "You should prepare some potions that makes you aim better, especially against sneaky bastards like these thieves."
    ar ""

translate traditional_chinese ratbandit_battle_lose_6186867a:

    # "You nod."
    ""

translate traditional_chinese ratbandit_battle_lose_d22fb43b:

    # ar "I'll be around, but he probably won't come back today at least."
    ar ""

translate traditional_chinese ratbandit_battle_lose_2f960729:

    # "The shepherd leaves to a spot near you, continuing taking care of his plants."
    ""

translate traditional_chinese sharkbandit_battle_b8a5c4a9:

    # "You are facing a shark bandit against the wall. You hold and clench your fist."
    ""

translate traditional_chinese sharkbandit_battle_8d772c8b:
...
translate traditional_chinese sharkbandit_battle_loop_132b45ce:

    # "You slash your [pc.weapon.name!t] at the arm of the shark, but it only scratches his skin."
    ""

translate traditional_chinese sharkbandit_battle_loop_9368897c:

    # "You slam your [pc.weapon.name!t] at the shark's head, but it only scratches his skin."
    ""

translate traditional_chinese sharkbandit_battle_loop_6088e10f:

    # "You aim and shoot your [pc.weapon.name!t] at the shark, but it only scratches his skin."
    ""

translate traditional_chinese sharkbandit_battle_loop_fa9cc593:

    # "You throw your fist at the shark, but it only scratches his skin."
    ""

translate traditional_chinese sharkbandit_battle_loop_6bedc127:

    # sbd "That's all you got?"
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_b3f9639a:

    # sbd "Huh."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_57889d5c:
...
translate traditional_chinese sharkbandit_battle_loop_9574a4a0:
...
translate traditional_chinese sharkbandit_battle_loop_e879391d:
...
translate traditional_chinese sharkbandit_battle_loop_fb9bd1b0:
...
translate traditional_chinese sharkbandit_battle_loop_a38345ad:

    # "You aim and shoot your [pc.weapon.name!t] at the shark, the arrow hit right into his shoulder."
    ""

translate traditional_chinese sharkbandit_battle_loop_7cf88a11:
...
translate traditional_chinese sharkbandit_battle_loop_d42a88ab:

    # "You throw your fist at the shark, hitting him right across his face, the sheer impact knocks him on the ground."
    ""

translate traditional_chinese sharkbandit_battle_loop_ea49aba5:

    # "You punch into the shark's stomach, grabbing him and slam him on the ground hard."
    ""

translate traditional_chinese sharkbandit_battle_loop_24bcc736:

    # "His health decreases by [oa[4]] HP."
    ""

translate traditional_chinese sharkbandit_battle_loop_17a649f0:

    # "You've critically hit the bandit, dealing [oa[4]] HP!"
    ""

translate traditional_chinese sharkbandit_battle_loop_a3975f77:

    # sbd "Argh! I haven't been hit for a long time!"
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_4b43a7a6:

    # sbd "It's just a scratch..."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_5fb6f023:

    # sbd "N-not, giving... up."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_e77c28bd:

    # sbd "I'll beat you RIGHT HERE! Come closer!"
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_fdf9de27:

    # "You turn around and rub your hand all over your own burly cheeks, feeling and brushing against your ass while you shake your hip."
    ""

translate traditional_chinese sharkbandit_battle_loop_f41f674d:
...
translate traditional_chinese sharkbandit_battle_loop_89520abd:
...
translate traditional_chinese sharkbandit_battle_loop_1fd87d43:

    # "You continue your act for about a minute, but the bandit doesn't even flinch."
    ""

translate traditional_chinese sharkbandit_battle_loop_d1f660f9:

    # sbd "Well..."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_8e008ede:
...
translate traditional_chinese sharkbandit_battle_loop_dbb089b2:

    # sbd "...I-if you do this one more time I'm going to grab that huge ass and never let you go..."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_d0975aae:
...
translate traditional_chinese sharkbandit_battle_loop_b6528234:

    # sbd "You are w-wasting your time. I'm n-not... I'm not... I- uhh... nooo..."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_4896910c:
...
translate traditional_chinese sharkbandit_battle_loop_9659ff35:

    # sbd "...It's nothing."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_e9df915d:

    # "You can tell the bandit is already playing with himself when his hand goes under his loincloth, staring at your ass intently. His lust is increased by [player_flirt]."
    ""

translate traditional_chinese sharkbandit_battle_loop_ef0db693:

    # sbd "Hnnnngh... ."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_42c3d693:

    # "The shark is blocking your escape..."
    ""

translate traditional_chinese sharkbandit_battle_loop_08d35d75:

    # "You are not ready to surrender yet."
    ""

translate traditional_chinese sharkbandit_battle_loop_791d4b96:

    # "The shark slows down, and drinks his red health potion."
    ""

translate traditional_chinese sharkbandit_battle_loop_f8a2d2ed:

    # sbd "Well, I'm good to go now."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_4b5a513f:
...
translate traditional_chinese sharkbandit_battle_loop_97c0625a:

    # sbd "I'll strike you down, like anyone else in my way."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_90f6895e:

    # "The shark bandit swings his axe towards you, you managed to deflect his bow and dodge the attack."
    ""

translate traditional_chinese sharkbandit_battle_loop_5baea727:

    # sbd "Lucky dodge."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_c5c89a14:
...
translate traditional_chinese sharkbandit_battle_loop_984e827c:

    # sbd "Come here, traveller. Need a drink?"
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_71755195:

    # "You gulp at his attempt at seduction. Admittedly you are extremely aroused, thinking about how his cock would taste like. Your lust increased by [enemy_flirt]."
    ""

translate traditional_chinese sharkbandit_battle_loop_0b1f2116:

    # "You stare at him, giving him weird side eyes. You have evaded his attempt at seduction."
    ""

translate traditional_chinese sharkbandit_battle_loop_9b3dd47a:

    # "The bandit stretches his body, flaunting his muscular physiques, you can tell his soft chest is almost bulging in front of you."
    ""

translate traditional_chinese sharkbandit_battle_loop_4ea0e3c8:

    # sbd "I can see your lustful eyes, you must be wanting this, don't you."
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_21bad776:

    # "You are stunned by his gorgeous muscles, you mind wanders through scenarios of him being inside your body. Your lust increased by [enemy_flirt]."
    ""

translate traditional_chinese sharkbandit_battle_loop_05b754b3:

    # "His attack at your lust seems to have failed as you stand there and wait for him to finish his taunt."
    ""

translate traditional_chinese sharkbandit_battle_loop_74a9e76b:

    # sbd "Ughhh-!!"
    sbd ""

translate traditional_chinese sharkbandit_battle_loop_4fe9c6fa:

    # "The shark bulges his muscle, he takes some food from his pocket and starts eating..."
    ""

translate traditional_chinese sharkbandit_battle_loop_d31e1cc7:

    # "He's getting bigger than before... with this, his maximum HP is also increasing by [health_increased]."
    ""

translate traditional_chinese sharkbandit_battle_lose_c7dea94a:

    # "You pant heavily, at this point it is just better to admit your defeat to the colossal shark in front of you."
    ""

translate traditional_chinese sharkbandit_battle_lose_14ee31c3:

    # sbd "So rare would we see a traveler just deliver himself right at my front door."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_452e5ccd:

    # sbd "Often we have to actually round these guys up, beat them up and take whatever we want."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_2f5d0fa9:

    # sbd "You were a good fighter."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_c610e3f0:

    # sbd "But, it still ends the same way it ends, with me on top."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_5597b182:

    # sbd "Now..."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_eb34bd6c:

    # sbd "Why are you here, traveller."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_a4cc2f6c:

    # "The bandit kneels, holding the edge of his axe over your neck."
    ""

translate traditional_chinese sharkbandit_battle_lose_9303bf6e:

    # e "...To catch the thief that stole our plums, that's it."
    e ""

translate traditional_chinese sharkbandit_battle_lose_fa9da81c:

    # sbd "Nothing else?"
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_d3e2cbe3:

    # "You nod. The bandit boss seems rather perplexed, but he just continues with his questioning."
    ""

translate traditional_chinese sharkbandit_battle_lose_34b4e2f0:

    # sbd "Where are you from?"
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_420a0dab:

    # e "Lusterfield, I f-followed the r-rat thief here."
    e ""

translate traditional_chinese sharkbandit_battle_lose_361186de:

    # sbd "The one where the hyena lives, huh? how's he?"
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_cd474b97:

    # e "Uh... doing well."
    e ""

translate traditional_chinese sharkbandit_battle_lose_127c8ba3:

    # "He chuckles, slowly pulling his axe away."
    ""

translate traditional_chinese sharkbandit_battle_lose_207cdaec:

    # sbd "Alright, you came over dangerous place here just for some plums."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_92178d26:

    # sbd "Tell me, what's the end goal here."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_d3c0018b:

    # e "I-I... I just wanted to catch the thief. I didn't know about you people."
    e ""

translate traditional_chinese sharkbandit_battle_lose_4678cfa9:

    # sbd "Fair."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_dde5ba0b:

    # sbd "Then, well."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_c3c82f40:

    # sbd "Let's get to the fun part, shall we?"
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_75ab91e4:

    # e "W-wait..."
    e ""

translate traditional_chinese sharkbandit_battle_lose_7a2f1390:
...
translate traditional_chinese sharkbandit_battle_lose_de79268b:

    # sbd "Or, if you are too much trouble, I'll just sell you out."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_ee2eabbb:

    # "The shark smiles, his cocks remains hanging in the air until he walks back and picks up his armors."
    ""

translate traditional_chinese sharkbandit_battle_lose_08df769d:

    # "You are left here, still completely exhausted from the fight."
    ""

translate traditional_chinese sharkbandit_battle_lose_65434ec1:
...
translate traditional_chinese sharkbandit_battle_lose_4c677d37:

    # sbd "You can keep your plums, but don't ever come back, I'd hate to break a good toy so soon."
    sbd ""

translate traditional_chinese sharkbandit_battle_lose_4b2d5523:

    # "Soon, you black out as the boss approaches you with full clothes, dragging you along the road."
    ""

translate traditional_chinese sharkbandit_battle_lose_02774032:

    # "A few hours passed."
    ""

translate traditional_chinese sharkbandit_battle_lose_a39fa1b0:
...
translate traditional_chinese sharkbandit_battle_lose_34cf9c4c:

    # "Your muscles are sore, ass still gaping from the cocks you've had."
    ""

translate traditional_chinese sharkbandit_battle_lose_0cc06f31:

    # "It seems your belly is getting smaller and smaller, but you're still leaking some leftover cum as you stand up."
    ""

translate traditional_chinese sharkbandit_battle_lose_8489be74:

    # "But, it was so good... feeling his cocks inside of you, being violently thrusted and-"
    ""

translate traditional_chinese sharkbandit_battle_lose_b0653e75:

    # "Shaking off the thoughts, you pick up your belongings and quickly carry onto your journey."
    ""

translate traditional_chinese sharkbandit_battle_lose_c8742c33:

    # "You lost [lost_gold] gold."
    ""

translate traditional_chinese sharkbandit_battle_win_ac0cf0cc:

    # sbd "F-fuck."
    sbd ""

translate traditional_chinese sharkbandit_battle_win_b6efe7ca:

    # "He lies on the ground, panting heavily. And his belly doesn't help but rolls him further down."
    ""

translate traditional_chinese sharkbandit_battle_win_9a5935ee:

    # msg "Bandit Boss Winning Scene WIP!"
    msg ""

translate traditional_chinese sharkbandit_battle_win_bc46e54b:

    # sbd "What do you want?"
    sbd ""

translate traditional_chinese sharkbandit_battle_win_1536264c:

    # e "Where's the thief that stole my plums?"
    e ""

translate traditional_chinese sharkbandit_battle_win_94a954d3:

    # sbd "Plums? They're over there, just take it."
    sbd ""

translate traditional_chinese sharkbandit_battle_win_9bc890e9:

    # sbd "Look, if you kill me right here, my people will make sure to destroy where you live, and you'll suffer for eternity."
    sbd ""

translate traditional_chinese sharkbandit_battle_win_53a12269:

    # sbd "Think you can handle all of them?"
    sbd ""

translate traditional_chinese sharkbandit_battle_win_f02f8a02:

    # e "Just tell me where the thief is."
    e ""

translate traditional_chinese sharkbandit_battle_win_e967f615:

    # sbd "..."
    sbd ""

translate traditional_chinese sharkbandit_battle_win_bd09c823:

    # sbd "He's out there, but I'm not giving him up."
    sbd ""

translate traditional_chinese sharkbandit_battle_win_addd4870:

    # e "Not at the risk of your life?"
    e ""

translate traditional_chinese sharkbandit_battle_win_5b95c291:

    # sbd "No. Take your plums and gold, but not my men."
    sbd ""

translate traditional_chinese sharkbandit_battle_win_dfa3ef8b:

    # e "A-alright, I don't want to kill anyone here."
    e ""

translate traditional_chinese sharkbandit_battle_win_c849fd86:

    # e "But if you and your thieves ever come back to our farm, I can't promise anything."
    e ""

translate traditional_chinese sharkbandit_battle_win_0079b4a8:

    # sbd "Whatever you say, adventurer."
    sbd ""

translate traditional_chinese sharkbandit_battle_win_2dffc7ee:

    # e "Can I trust your words?"
    e ""

translate traditional_chinese sharkbandit_battle_win_d6fbb0fc:

    # sbd "People often say you shouldn't trust a bandi-"
    sbd ""

translate traditional_chinese sharkbandit_battle_win_888bc334:

    # "You blankly stare at him, with your weapon still on your hand."
    ""

translate traditional_chinese sharkbandit_battle_win_9438339a:

    # sbd "But y-yes."
    sbd ""

translate traditional_chinese sharkbandit_battle_win_d5298768:

    # "You leave the bandit boss behind and take the plum inside the hideout before you pick up your stuff, and move on."
    ""

translate traditional_chinese sharkbandit_battle_win_01346965:

    # "The shark gives you a few glances before getting up, going back to his shelter pretending like nothing happened."
    ""

translate traditional_chinese sharkbandit_battle_win_0efb5857:

    # "With the boss' promise. At least you can now go back with the plums and not having to worry about the thief."
    ""

translate traditional_chinese sharkbandit_battle_win_a20cefa7:

    # "..."
    ""

translate traditional_chinese sharkbandit_battle_win_4606f40b:

    # "You received 300 exp and 150 gold."
    ""

translate traditional_chinese sharkbandit_battle_win_91f1d522:
